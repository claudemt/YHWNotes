...
若单粒子色散改为 \(\varepsilon_p=\sqrt{p^2c^2+m^2c^4}-mc^2\)，Gauss 积分被 Bessel 函数 \(K_2(n\beta mc^2)\) 替代，团簇 系数 不再是简单的 \(n^{-5/2}\) 而含相对论修正因子。在非相对论极限 \(\beta mc^2\gg1\) 下 \(K_2(x)\sim\sqrt{\pi/(2x)}\ee^{-x}\) 退化为经典结果。
\end{derivation}
...
\begin{derivation}[zero-值域 相移积分]
 把连续谱积分化为 Gaussian--Lorentz 卷积，用 Feynman 技巧积出，再并入束缚态项并检验三个物理极限。
