...
with figure_style():
    ...
    ax.set_xlabel('Sweep coordinate / time'); ax.set_ylabel('Energy (arb. units)'); add_legend(ax); polish_axes(ax,grid=True); fig.tight_layout(); save_pdf_png_pair(fig,'landau_zener',Path(__file__).resolve().parents[1]/'generated')
