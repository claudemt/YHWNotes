...
with figure_style():
    ...
    add_legend(ax,loc='upper right',frameon=False); polish_axes(ax,grid=True); fig.tight_layout(); save_pdf_png_pair(fig,'rabi_dynamics',Path(__file__).resolve().parents[1]/'generated')
