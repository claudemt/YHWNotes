...
\begin{equation}
\boxed{
\mathcal A:\mathfrak D_{\mathcal A}\to\mathcal S(\HH_S\otimes\HH_B),
\qquad
...
\ee^{-\ii z_{r,N}t/\hbar}
\prod_{s\ne r}
\frac{M_N-z_{s,N}\Id_{d_N}}{z_{r,N}-z_{s,N}}.}
...
\frac{M_N^{(2)}-z_{-,N}\Id_2}{z_{+,N}-z_{-,N}}
+\ee^{-\ii z_{-,N}t/\hbar}
\frac{M_N^{(2)}-z_{+,N}\Id_2}{z_{-,N}-z_{+,N}}.
\]
