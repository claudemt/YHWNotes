...
\end{equation}
即\eqnrefs{eq:burnside-orbit-count}，Burnside 引理。注意此处 \(\chi_{\rm perm}\) 取值于非负整数；若考虑模 2 约化，\(\chi_{\rm perm}\bmod 2\) 给出 \(\mathbb F_2\) 上轨道奇偶性的 \(\mathbb F_2\)-值特征标，可用于检测轨道数为奇数的必要条件。
