...
\begin{proof}[解]
对径向哈密顿量 \(H=-\frac{\hbar^2}{2m}\frac{\dd^2}{\dd r^2}+V_{\rm eff}(r)\)（\(V_{\rm eff}=V(r)+\frac{\hbar^2\ell(\ell+1)}{2mr^2}\)），定义超位力算符 \(G=r^s\frac{\dd}{\dd r}+\frac{s}{2}r^{s-1}\)（\(s\) 为非负整数）。对束缚态 \(|n\rangle\)，超位力关系来自
\begin{equation*}
