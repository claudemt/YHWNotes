...
接下来考察 runaway、无 runaway 分支与预加速。
...
\[
 ...
 F_\parallel(\tau).
\]
一般解包含 \(e^{\tau/\tau_{\rm rr}}\) 齐次模。施加未来无 runaway 边界条件，
从 \(\tau\) 积分到 \(+\infty\)，得到
\[
...
若外力在固有时尺度 \(T\) 上光滑变化，无 runaway 积分的局域展开为
\begin{equation}
 mc\dot\psi
...
\end{equation}
这说明 Landau--Lifshitz 方程是 ALD 无 runaway 分支的受控低频展开。定义
\begin{equation}
 \mathsf P_u^\mu{}_\nu
 =\delta^\mu{}_\nu-\frac{u^\mu u_\nu}{c^2}.
...
若 \(\|F_\parallel^{(n)}\|\sim\mathcal F_\star/T^n\)，在无 runaway 积分中展开
\[
