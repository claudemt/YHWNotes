...
\end{equation}
取 \(K=0\) 态归入 \(\sigma=+1\) 子空间。定义 Wang 宇称算符 \(\mathsf P|J,K\rangle=|J,-K\rangle\)，则 \(|J,K,\sigma\rangle\) 正是 \(\mathsf P\) 的本征态（本征值 \(\sigma\)）。Hamiltonian 在 \(K\leftrightarrow-K\) 下不变意味着 \([H,\mathsf P]=0\)，于是
\[
