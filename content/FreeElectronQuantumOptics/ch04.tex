...
\begin{figure}[htbp]
 \centering
 \resizebox{0.92\textwidth}{!}{\input{figures/tikz/qed-tree-atlas-dp7}}
...
\begin{figure}[htbp]
 \centering
 \resizebox{0.92\textwidth}{!}{\input{figures/tikz/qed-loop-atlas-dp7}}
