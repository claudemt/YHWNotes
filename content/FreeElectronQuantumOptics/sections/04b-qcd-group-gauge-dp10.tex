...
\begin{figure}[htbp]
 \centering
 \includegraphics[width=.76\linewidth]{content/FreeElectronQuantumOptics/figures/generated/qcd_color_factors_dp18.png}
...
\begin{figure}[htbp]
\centering
\resizebox{0.94\textwidth}{!}{\input{figures/tikz/qcd-elementary-vertices-dp10}}
