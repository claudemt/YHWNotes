...
\end{equation}
其中 $\hbar^2/|\mathbf p|^2$ 显式给出面积量纲。再取非相对论极限 $|\mathbf p|\simeq \me v$、$\beta_{\rm rel}\simeq v/c$，便得到 Rutherford 公式
\begin{equation}
 \boxed{
...
\begin{align*}
 ...
 &=\frac12\Tr[(\slashed p'+\me c)\gamma^0
 (\slashed p+\me c)\gamma^0]\\
 &=2\left[2p'^0p^0-(p'\!\cdot p-\me^2c^2)\right].
\end{align*}
弹性条件 $p'^0=p^0=E/c$ 以及
\begin{equation*}
 p'\!\cdot p=\frac{E^2}{c^2}-|\mathbf p|^2\cos\theta,
 \qquad
 \frac{E^2}{c^2}=|\mathbf p|^2+\me^2c^2
\end{equation*}
给出
\begin{equation*}
 N_e
...
最后取 $|\mathbf p|\simeq \me v$、$\beta_{\rm rel}\simeq v/c$：
\begin{equation*}
 \frac{\dd\sigma}{\dd\Omega}
 \longrightarrow
 \frac{Z^2\alpha^2\hbar^2c^2}
 {4\me^2v^4\sin^4(\theta/2)}.
\end{equation*}
由
\begin{equation*}
 \alpha=\frac{e^2}{4\pi\varepsilon_0\hbar c},
 \qquad
 E_{\rm kin}=\frac12\me v^2,
\end{equation*}
其系数逐步化为
\begin{align*}
 \frac{Z^2\alpha^2\hbar^2c^2}{4\me^2v^4}
 &=\frac{Z^2}{4\me^2v^4}
