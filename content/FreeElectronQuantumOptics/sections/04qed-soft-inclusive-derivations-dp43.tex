...
质量壳关系给
\begin{equation*}
 \beta_{\rm rel}^2=1-\frac{\me^2c^4}{E^2},
\end{equation*}
令 $x\equiv\me^2c^4/E^2$。质量壳关系给 $\beta_{\rm rel}=\sqrt{1-x}$，所以
\begin{align*}
1-\beta_{\rm rel}
&=\frac{x}{1+\sqrt{1-x}}\\
&=\frac{x}{2}+O(x^2)
=\frac{\me^2c^4}{2E^2}
+O\!\left(\frac{\me^4c^8}{E^4}\right).
\end{align*}
保留 $\theta^2$ 和 $\me^2c^4/E^2$ 的最低非零阶，得到\eqnrefs{eq:soft-collinear-denominator-dp10}。这也显示电子质量如何把严格共线分母从零抬升为有限值。
\end{derivation}
