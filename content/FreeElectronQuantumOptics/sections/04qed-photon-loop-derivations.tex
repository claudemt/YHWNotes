...
\begin{equation*}
 \mathcal K_{\rm BW}^{\mu\nu}
 =\gamma^\mu\frac{\slashed p+\slashed k+\me c}{2a}\gamma^\nu
 -\gamma^\nu\frac{\slashed p-\slashed k'+\me c}{2b}\gamma^\mu .
\end{equation*}
初态电子自旋和光子偏振各平均一次，末态求和。由于完整振幅已经满足 Ward 条件，偏振和中的规范项不贡献，因此
\begin{equation*}
 \overline{|\mathcal M_C|^2}
 =\frac{g_{\rm em}^4}{4}
 \Tr\!\left[(\slashed p'+\me c)\mathcal K_{\rm BW}^{\mu\nu}
 (\slashed p+\me c)\overline{\mathcal K}_{{\rm BW},\mu\nu}\right].
\end{equation*}
质量壳与动量守恒给出
\begin{equation*}
 k\cdot k'=a-b,\qquad
 p\cdot p'=\me^2c^2+a-b,
\end{equation*}
以及内部电子动量
\begin{equation*}
 r_s=p+k,\quad r_u=p-k',\quad
 r_s^2=\me^2c^2+2a,\quad r_u^2=\me^2c^2-2b.
\end{equation*}
把迹分成 $ss$、$uu$ 与两图干涉三部分。对 $ss$ 项，先用
\begin{equation*}
 \gamma^\nu(\slashed p+\me c)\gamma_\nu=-2\slashed p+4\me c
\end{equation*}
和
\begin{equation*}
...
\begin{align*}
 T_{ss}
 &=\Tr\!\left[(\slashed p'+\me c)\gamma^\mu(\slashed r_s+\me c)
 \gamma^\nu(\slashed p+\me c)\gamma_\nu(\slashed r_s+\me c)\gamma_\mu\right]\\
 &=32\left(\me^4c^4+\me^2c^2a+ab\right).
\end{align*}
连同平均因子和 $(2a)^{-2}$ 的传播子分母，
\begin{equation*}
 \overline{|\mathcal M_s|^2}
 =2g_{\rm em}^4\left(\frac ba+\frac{\me^2c^2}{a}+\frac{\me^4c^4}{a^2}\right).
\end{equation*}
$uu$ 项同样给出
\begin{equation*}
 \overline{|\mathcal M_u|^2}
 =2g_{\rm em}^4\left(\frac ab-\frac{\me^2c^2}{b}+\frac{\me^4c^4}{b^2}\right).
\end{equation*}
交叉迹在两种次序下相同，
\begin{equation*}
 T_{su}=T_{us}=16\me^2c^2(2\me^2c^2+a-b),
\end{equation*}
而正文振幅中的相对负号使干涉贡献成为
\begin{equation*}
 \overline{2\Re(\mathcal M_s\mathcal M_u^*)}
 =2g_{\rm em}^4\left[
 \me^2c^2\left(\frac1a-\frac1b\right)
 -\frac{2\me^4c^4}{ab}\right].
\end{equation*}
三部分相加并整理同次幂的 $1/a,1/b$，得到正文\eqnrefs{eq:compton-M2-unpolarized-dp73}。

电子静止系中
\begin{equation*}
 p^\mu=(\me c,\mathbf0),\qquad
 a=\me\hbar\omega,\qquad b=\me\hbar\omega'.
\end{equation*}
...
\begin{equation*}
 E_e'=\sqrt{\me^2c^4+c^2|\mathbf p'|^2}.
\end{equation*}
...
\begin{equation*}
 ...
 \dd\omega'\dd\Omega\,
 \delta\!\left(\me c^2+\hbar\omega-E_e'-\hbar\omega'\right).
\end{equation*}
...
\begin{align*}
 |f'(\omega')|
 &=\frac{\hbar}{E_e'}
 \left[\me c^2+\hbar\omega(1-\cos\theta)\right]\\
 &=\frac{\hbar\me c^2}{E_e'}\frac\omega{\omega'}.
\end{align*}
因此用 $\delta[f]=\delta(\omega'-\omega'_*)/|f'(\omega'_*)|$ 完成能量积分后，
\begin{equation*}
 \frac{\dd\mathfrak P_2}{\dd\Omega}
 =\frac{\hbar}{16\pi^2\me c^2}\frac{\omega'^2}{\omega}.
\end{equation*}
正文\eqnrefs{eq:compton-invariant-flux-r14} 给出入射通量
$\mathcal I_{e\gamma}=\me\hbar\omega$。代入 SI 约化振幅的截面母式
\begin{equation*}
 \dd\sigma
...
\begin{equation*}
 ...
 =\frac{\hbar^2}{64\pi^2\me^2c^2}
 \left(\frac{\omega'}\omega\right)^2
 \overline{|\mathcal M_C|^2}.
\end{equation*}
最后使用 $g_{\rm em}^2=4\pi\alpha$ 与
$r_e=\alpha\hbar/(\me c)$，便得到正文\eqnrefs{eq:klein-nishina-SI}。
\end{derivation}
...
\begin{equation*}
 ...
 \frac{\slashed p_1-\slashed k_1+\me c}{(p_1-k_1)^2-\me^2c^2}
 \slashed\varepsilon_1^*
 +\slashed\varepsilon_1^*
 \frac{\slashed p_1-\slashed k_2+\me c}{(p_1-k_2)^2-\me^2c^2}
 \slashed\varepsilon_2^*
 \right]u(p_1).}
 \end{equation*}
\end{derivation}
...
\begin{equation*}
 ...
 u=(k_2-p_1)^2,
\end{equation*}
并使用正文\eqnrefs{eq:BW-stu-si-r12} 的 $s+t+u=2\me^2c^2$。质心系末态速率参数为
\begin{equation*}
 \beta_{\rm pair}=\sqrt{1-\frac{4\me^2c^2}{s}},
\end{equation*}
因此
\begin{equation*}
...
\begin{align*}
 t-\me^2c^2&=-\frac{s}{2}(1-\beta_{\rm pair}\cos\theta),\\
 u-\me^2c^2&=-\frac{s}{2}(1+\beta_{\rm pair}\cos\theta).
\end{align*}
...
\begin{align*}
 a&\to-p_2\cdot k_1
 =\frac{u-\me^2c^2}{2}=\frac U2,\\
 b&\to p_2\cdot k_2
 =-\frac{t-\me^2c^2}{2}=-\frac T2.
\end{align*}
第二行使用了四动量守恒 $k_2-p_2=p_1-k_1$。

平方振幅的交叉还必须处理费米子完备关系。Compton 初态电子自旋和含
\begin{equation*}
 \sum_su_s(p)\bar u_s(p)=\slashed p+\me c.
\end{equation*}
解析延拓 $p\to-p_2$ 后，
\begin{equation*}
 \slashed p+\me c
 \longrightarrow
 -\slashed p_2+\me c
 =-\bigl(\slashed p_2-\me c\bigr),
\end{equation*}
而括号内正是末态正电子的完备关系
\begin{equation*}
 \sum_sv_s(p_2)\bar v_s(p_2)=\slashed p_2-\me c.
\end{equation*}
...
\begin{align*}
 ...
 =2g_{\rm em}^4\Bigg[
 &\frac UT+\frac TU
 -4\me^2c^2\left(\frac1U+\frac1T\right)\\
 &-4\me^4c^4\left(\frac1U+\frac1T\right)^2
 \Bigg].
\end{align*}
由
\begin{equation*}
...
并且
\begin{equation*}
 \me^2c^2=\frac s4(1-\beta_{\rm pair}^2).
\end{equation*}
因此
\begin{align*}
 TU
...
最后代入
\begin{equation*}
 s=\frac{4\me^2c^2}{1-\beta_{\rm pair}^2},\qquad
 g_{\rm em}^4=(4\pi\alpha)^2,\qquad
 r_e=\frac{\alpha\hbar}{\me c},
\end{equation*}
...
记约化自由电子传播子为
\begin{equation*}
 S_0(\ell)=\frac{\slashed\ell+\me c}{\ell^2-\me^2c^2+\ii0^+},
 \qquad
 S_{0}^{-1}(\ell)=\slashed\ell-\me c .
\end{equation*}
由
\begin{equation*}
...
\[
 L\equiv \ell+(1-x)q,
 \qquad
 \Delta_\Pi\equiv \me^2c^2-x(1-x)q^2,
\]
则
\[
...
&\equiv
\Tr\!\left[
\gamma^\mu(\slashed\ell+\me c)
\gamma^\nu(\slashed\ell+\slashed q+\me c)
\right]\\
&=4\left[
\ell^\mu(\ell+q)^\nu
+\ell^\nu(\ell+q)^\mu
-\eta^{\mu\nu}
\bigl(\ell\!\cdot(\ell+q)-\me^2c^2\bigr)
\right].
\end{align*}
代入
...
+\order(\epsilon).
\end{align*}
在 $q^2=0$ 时，$\Delta_\Pi(x,0)=\me^2c^2$，所以同一表达式给
\begin{align*}
\Pi(0)
=\frac{2\alpha}{\pi}
\int_0^1\dd x\,x(1-x)
...
当时间样 $q^2=s>4\me^2c^2$ 时，\eqnrefs{eq:Pi-Delta-r12} 在一段 Feynman-参数区间内变负。方程
...
等价于
\begin{equation*}
 x^2-x+\frac{\me^2c^2}{s}=0,
\end{equation*}
根为
\begin{equation*}
 x_\pm=\frac12(1\pm\beta_{\rm pair}),
 \qquad
 \beta_{\rm pair}\equiv\sqrt{1-\frac{4\me^2c^2}{s}}.
\end{equation*}
...
\begin{equation*}
 \ln\frac{\me^2c^2}{-A-\ii0^+}
 =\ln\frac{\me^2c^2}{A}+\ii\pi.
\end{equation*}
于是
\begin{align*}
 ...
 \right]_{x_-}^{x_+}.
\end{align*}
利用 $x_++x_-=1$、$x_+-x_-=\beta_{\rm pair}$ 与 $x_+x_-=\me^2c^2/s$，可化为
\begin{equation*}
 {
 \operatorname{Im}\Pi_R(s)
 =\frac{\alpha}{3}\,
 \beta_{\rm pair}\left(1+\frac{2\me^2c^2}{s}\right).}
 \end{equation*}
\end{derivation}
...
\begin{equation*}
 ...
 =-\ii g_{\rm em}^2
 \int_{\ell}^{(d)}
 \frac{\gamma^\mu(\slashed p-\slashed\ell+\me c)\gamma_\mu}
 {[\ell^2+\ii0^+][(p-\ell)^2-\me^2c^2+\ii0^+]}.
 \end{equation*}
...
得到
\begin{equation*}
 \gamma^\mu(\slashed p-\slashed\ell+\me c)\gamma_\mu
 =(2-d)(\slashed p-\slashed\ell)+d\me c.
 \end{equation*}
用 \eqnrefs{eq:feynman-parameter-proof-r9} 合并两个分母：
\begin{align*}
 &x[(p-\ell)^2-\me^2c^2]+(1-x)\ell^2\\
...
\begin{align*}
 ...
 =-\ii g_{\rm em}^2
 \int_0^1\dd x\,
 \bigl[(2-d)(1-x)\slashed p+d\me c\bigr]
 I_2(\Delta_\Sigma).
 \end{align*}
...
\begin{align*}
 ...
 \int_0^1\dd x
 \left[-2(1-x)\slashed p+4\me c\right],\\
 &=\frac{\alpha}{4\pi}\frac1\epsilon
 \left(-\slashed p+4\me c\right).
 \end{align*}
因此电子场强反项与质量反项必须分别吸收 $\slashed p$ 和 $\me c$ 两种独立结构；Lorentz 协变的二点函数中没有第三个独立反项结构可供调节。
\end{derivation}
...
\begin{equation*}
 ...
 \end{equation*}
其支撑从 $s_0=4\me^2c^2$ 开始。该阈值由光子单粒子不可约二点函数的 Cutkosky 切割决定：费米子与反费米子两条内部线同时满足
\begin{equation*}
 p_-^2=p_+^2=\me^2c^2,
 \qquad
 p_-^0>0,\quad p_+^0>0,
 ...
 q=p_-+p_+,
\end{equation*}
因此只有虚光子的 Lorentz 不变质量达到 $2\me c$ 后，真实 $e^-e^+$ 在壳相空间才打开。
...
令 $a\equiv \me^2c^2$ 只在本段积分中作紧凑记号。由 \eqnrefs{eq:qed-vacpol-spacelike-dispersion-dp9}，当 $Q^2\ll a$，
...
\begin{equation*}
 ...
 =-\frac{\alpha}{15\pi}
 \frac{Q^2}{\me^2c^2}
 +\order\!\left(\frac{Q^4}{\me^4c^4}\right),}
 \end{equation*}
...
\begin{equation*}
 p^2\ge (\me+m_\gamma)^2c^2.
 \end{equation*}
因此调节参数存在时，物理电子极点 $p^2=\me^2c^2$ 与连续谱阈值分离，精确传播子具有通常的孤立极点；对当前场变量，其 LSZ 极点权重记为 $Z_{\rm pole}^{(e)}$，可由极点邻域的逆传播子导数求出。若随后采用在壳重整化，则场强反项中的 $Z_2$ 被选择来把重整化传播子的这一物理极点权重归一化为 $1$。

现在令 $m_\gamma\to0$。阈值向 $p^2=\me^2c^2$ 靠近，但这不意味着自由电子可以发出一个有限能量实光子。若假设
\begin{equation*}
 p\to p'+k,
 \qquad
 p^2=p'^2=\me^2c^2,
...
\begin{equation*}
 ...
 \end{equation*}
这给出 Gordon 恒等式；由于 $p^\mu$ 与 $q^\mu$ 都具有动量量纲，分母必须为 $2\me c$。
...
+x(p'^2-\me^2c^2)+y(p^2-\me^2c^2)+\ii0^+\\
...
=L^2-(xp'+yp)^2+\ii0^+.
\end{equation*}
由 $q=p'-p$ 与 $p^2=p'^2=\me^2c^2$，
\begin{align*}
2p\!\cdot p'&=2\me^2c^2-q^2,\\
(xp'+yp)^2
&=(x+y)^2\me^2c^2-xyq^2\\
&=(1-z)^2\me^2c^2-xyq^2
=\Delta_V(x,y,z;q^2).
...
\begin{equation*}
 N_0^\mu
 =\gamma^\alpha(\slashed A+\me c)
 \gamma^\mu(\slashed B+\me c)\gamma_\alpha.
\end{equation*}
...
\begin{align*}
 ...
 =&\,\bar u\Bigl[
 z^2\me^2c^2\gamma^\mu
 +z\me c(1-x)\gamma^\mu\slashed q\\
 &\qquad-z\me c(1-y)\slashed q\gamma^\mu
...
\begin{equation*}
 (p'+p)^\mu
 \doteq 2\me c\gamma^\mu-\ii\sigma^{\mu\nu}q_\nu,
\end{equation*}
其中 $\doteq$ 表示两侧夹在同一对在壳旋量之间时相等。因此，第一项
$-2\slashed B\gamma^\mu\slashed A$ 的 Pauli 部分是
\begin{equation*}
 +2\ii z\me c(1+z)\sigma^{\mu\nu}q_\nu,
\end{equation*}
第二项 $4\me c(A+B)^\mu$ 的 Pauli 部分是
\begin{equation*}
 -4\ii z\me c\sigma^{\mu\nu}q_\nu.
\end{equation*}
相加得到
\begin{equation*}
 N_0^\mu\Big|_{\rm Pauli}
 =-2\ii z(1-z)\me c\,\sigma^{\mu\nu}q_\nu.
\end{equation*}
...
由参数化后的顶角积分和刚得到的 $N_2=4z(1-z)\me^2c^2$，一圈 Pauli 形状因子是
\begin{equation*}
 F_2^{\rm 1L}(q^2)
 =2\ii g_{\rm em}^2
...
现在取 $q^2=0$。由参数化分母
\begin{equation*}
 \Delta_V=(1-z)^2\me^2c^2,
\end{equation*}
所以
\begin{equation*}
 \frac{N_2}{\Delta_V}
 =\frac{4z(1-z)\me^2c^2}{(1-z)^2\me^2c^2}
 =\frac{4z}{1-z}.
\end{equation*}
...
\begin{align*}
 ...
 &={\frac{\alpha}{2\pi}},
 \end{align*}
最后一步用了 $g_{\rm em}^2=4\pi\alpha$。整个计算中 $\me^2c^2$ 在分子与分母中显式相消，因此 $F_2(0)$ 自然保持无量纲。
\end{derivation}
...
\begin{equation*}
 ...
 =-\frac{\qe}{\me}\mathbf S_{1/2}\cdot\mathbf B,
\end{equation*}
其中 $\mathbf S_{1/2}=\hbar\boldsymbol\sigma_{\rm P}/2$。正文已经用
$H_B=-(g_{\rm mag}\qe/2\me)\mathbf S_{1/2}\cdot\mathbf B$ 固定了旋磁因子的物理含义；这里仅比较顶角中两个磁张量的系数。

由 Gordon 恒等式，$F_1\gamma^\mu$ 自身已经含有
$F_1\,\ii\sigma^{\mu\nu}q_\nu/(2\me c)$ 磁张量；Pauli 形状因子又增加
$F_2\,\ii\sigma^{\mu\nu}q_\nu/(2\me c)$。因此静态极限 $q^2\to0$ 的磁耦合相对于树级 Dirac 结果乘上
$F_1(0)+F_2(0)$：
\begin{equation*}
 {
...
\begin{align*}
 ...
 &=\frac{g_{\rm em}^2}{16\pi^2}
 \int_0^1\dd u_F
 \frac{\me^2c^2}{\me^2c^2-u_F(1-u_F)q^2}
 \int_0^1\dd w\,4(1-w),\\
 &={
 \frac{\alpha}{2\pi}
 \int_0^1\dd u_F\,
 \frac{\me^2c^2}
 {\me^2c^2-u_F(1-u_F)q^2}}.
 \end{align*}
...
取点状原子核电荷为 $+Ze$、电子电荷为 $\qe=-e$。静态 Coulomb 势能为
...
\begin{equation*}
 ...
 =\frac{2\alpha}{\pi}
 \int_0^1\dd x\,x(1-x)
 \ln\left[1+\frac{Q^2}{\me^2c^2}x(1-x)\right].
 \end{equation*}
...
三维 Fourier 变换可借助一次减除的色散表示。$\Pi_R(z)/z$ 在复 $z$ 平面除 $z\ge4\me^2c^2$ 的支割外解析，并且 $\Pi_R(0)=0$。对包围支割的 Cauchy 围道，
\begin{equation*}
 \frac{\Pi_R(z)}{z}
 =\frac1{2\pi\ii}
 \int_{4\me^2c^2}^{\infty}\dd s\,
...
\begin{equation*}
 ...
 =\frac{\alpha}{3\pi}
 \int_{4\me^2c^2}^{\infty}\frac{\dd s}{s(s+Q^2)}
 \sqrt{1-\frac{4\me^2c^2}{s}}
 \left(1+\frac{2\me^2c^2}{s}\right).
 \end{equation*}
...
\begin{align*}
 ...
 \int_{4\me^2c^2}^{\infty}\frac{\dd s}{s}
 \ee^{-\sqrt s\,r/\hbar}
 \sqrt{1-\frac{4\me^2c^2}{s}}
 \left(1+\frac{2\me^2c^2}{s}\right).
\end{align*}
...
\end{equation*}
并定义约化 Compton 波长 $\lambda_C\equiv\hbar/(\me c)$，得到经典 Uehling 修正：
\begin{equation*}
 {
 \delta V_U(r)
...
\begin{equation*}
 [\ii\hbar\slashed\partial-\qe\slashed A(\phi)-\me c]\psi(x)=0.
 \end{equation*}
原式整体除以 $c$ 后，三项都具有动量量纲。

取自由在壳自旋子 $u_s(p)$，满足
\begin{equation*}
 (\slashed p-\me c)u_s(p)=0.
\end{equation*}
定义
\begin{align*}
 R_p(\phi)
 &\equiv
 1+\frac{\qe}{2p\cdot\kappa}
 \slashed\kappa\slashed A(\phi),\\
 F_p(\phi)
 &\equiv
 \frac{\qe p\cdot A(\phi)}{p\cdot\kappa}
 -\frac{\qe^2A^2(\phi)}{2p\cdot\kappa},\\
 S_p(x)
 &\equiv p\cdot x+\int^{\phi}\dd\varphi\,F_p(\varphi).
 \end{align*}
量纲检查很直接：$p\cdot\kappa$ 是动量/长度，$\qe A$ 是动量，因此 $R_p$ 无量纲；$F_p$ 具有作用量量纲，因为相位变量 $\phi$ 无量纲，所以 $S_p/\hbar$ 无量纲。
...
\end{equation*}
以及 $\slashed p u_s=\me cu_s$：
\begin{align*}
 \slashed pR_pu_s
 &=\me cu_s+\frac{\qe}{2p\cdot\kappa}
 \slashed p\slashed\kappa\slashed A u_s,\\
 &=\me cu_s+\qe\slashed A u_s
 -\frac{\qe}{2p\cdot\kappa}
 \slashed\kappa\slashed p\slashed A u_s,\\
 &=\me cR_pu_s+\qe\slashed A u_s
 -\qe\frac{p\cdot A}{p\cdot\kappa}\slashed\kappa u_s.
 \end{align*}
...
\begin{equation*}
 \qe\slashed A R_pu_s
 =\qe\slashed A u_s
 -\frac{\qe^2A^2}{2p\cdot\kappa}\slashed\kappa u_s.
 \end{equation*}
同时 $\slashed\kappa R_p=\slashed\kappa$，故
\begin{equation*}
 \slashed\kappa F_p R_pu_s
 =\left[
 \qe\frac{p\cdot A}{p\cdot\kappa}
 -\frac{\qe^2A^2}{2p\cdot\kappa}
 \right]\slashed\kappa u_s.
 \end{equation*}
$\slashed pR_pu_s$、$\qe\slashed A R_pu_s$ 与 $\slashed\kappa F_pR_pu_s$ 三个结果相加后，$\qe\slashed A$、$p\cdot A$ 与 $A^2$ 三类项逐项相消，最后只剩
\begin{equation*}
 \me cR_pu_s-\me cR_pu_s=0.
\end{equation*}
...
\begin{equation*}
 ...
 \bar p^\mu
 =p^\mu
 -\frac{\qe^2\langle A^2\rangle_\phi}{2p\cdot\kappa}\kappa^\mu.}
 \end{equation*}
因为 $\kappa^2=0$，
\begin{align*}
 \bar p^2
 &=p^2-\qe^2\langle A^2\rangle_\phi,\\
 &=\me^2c^2-\qe^2\langle A^2\rangle_\phi.
\end{align*}
横向平面波有 $A^2<0$，所以准动量对应的有效质量增大。若定义峰值归一化矢势
\begin{equation*}
 a_0\equiv\frac{|\qe|A_0}{\me c},
\end{equation*}
则圆偏振的 $\langle A^2\rangle=-A_0^2$ 给
\begin{equation*}
 {m_*^{\rm circ}=\me\sqrt{1+a_0^2},}
\end{equation*}
而线偏振可取 $A^\mu(\phi)=\mathcal A^\mu\cos\phi$，并定义正的峰值幅度 $A_0\equiv\sqrt{-\mathcal A^2}$；于是 $\langle A^2\rangle=\mathcal A^2/2=-A_0^2/2$，故
\begin{equation*}
 {m_*^{\rm lin}=\me\sqrt{1+\frac{a_0^2}{2}}.}
 \end{equation*}
