...
\end{equation*}
对相对论色散 $E(p)=\sqrt{\me^2c^4+c^2p^2}$，逐次求导得到
\begin{align*}
E'(p)&=\frac{c^2p}{E},\\
E''(p)&=\frac{\me^2c^6}{E^3},\\
E'''(p)&=-\frac{3\me^2c^8p}{E^5}.
\end{align*}
在 $p_0=\gamma_0\me v_0$、$E_0=\gamma_0\me c^2$ 处，
\begin{equation*}
E_0^{(3)}=-\frac{3v_0}{\gamma_0^4\me^2c^2}.
\end{equation*}
传播时间 $t$ 把能量误差累积成相位误差
\begin{equation*}
...
\end{align*}
其中用了 $m_\parallel=\gamma_0^3\me$ 与 $p_0=\gamma_0\me v_0$。因此 $\epsilon_{\rm win}$ 控制三阶相位相对于二阶相位的比例，而 $\varphi_3^{\max}$ 决定三阶绝对相位是否可分辨；二者承担不同角色。二阶反冲格在给定时间内要求 $\varphi_3^{\max}\ll1$。
\end{derivation}
