...
同一 QED 母理论在三个不同极限中呈现出三种可复用结构：真空极化修正静态光子传播子，软定理控制低能真实光子辐射，经典平面波背景则可以非微扰地吸收到 Dirac 方程的零阶解中。三者都沿用物理四动量、$\qe=-e$ 和统一 Fourier 约定。
...
\begin{equation}
 ...
 \qquad
 \bar p^2=\me^2c^2-\qe^2\langle A^2\rangle_\phi.}
