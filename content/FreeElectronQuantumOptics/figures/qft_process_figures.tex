...
\draw[->] (J.east)--(E.west) node[process line label,midway,above=4pt,font=\small] {source};
\draw[->] (M.east)--(G.west) node[process line label,midway,below=4pt,font=\small] {invert};
