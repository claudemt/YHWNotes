...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{ellipsoidal_coordinates_schematic_diagram.png}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.68\textwidth}
		\includegraphics[width=\textwidth]{ellipsoidal_coordinates_schematic_diagram_2.png}
	\end{subfigure}
	\caption{椭球坐标示意图}
