\chapter{伊辛模型的 Bethe 与 Bragg--Williams 描述}
...
&=\left.\frac1{Nk}\frac{\dd E}{\dd T}\right|_{h=0}\\
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{state_probability.png}
		\caption{状态概率}
		\label{fig:ising_state_probability_vs_T}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{magnetic_susceptibility.png}
		\caption{磁化率}
		\label{fig:ising_susceptibility_vs_T}
	\end{subfigure}

	\vspace{0.1cm}
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{order_parameter.png}
		\caption{序参量}
		\label{fig:ising_order_parameter_vs_T}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{heat_capacity.png}
		\caption{热容}
		\label{fig:ising_heat_capacity_vs_T}
	\end{subfigure}
	\caption{Bethe 描述下各统计量随温度变化图}
	\label{fig:ising_observables_vs_T}
\end{figure}

\section{一维链：树图方法的严格基准}
