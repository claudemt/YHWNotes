...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{toroidal_electric_dipole_moment.png}
		\caption{环形电偶极矩}
		\label{fig:toroidal_electric_dipole}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{toroidal_magnetic_dipole_moment.png}
		\caption{环形磁偶极矩}
		\label{fig:toroidal_magnetic_dipole}
	\end{subfigure}
	\caption{环形偶极矩示意图}
	\label{fig:toroidal_dipole}
\end{figure}