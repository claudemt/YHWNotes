...
\section{球对称散射问题}
\section{电磁场按球坐标系展开}
\label{sec:em_field_spherical_expansion}
...
\begin{equation*}
	\begin{aligned}
		\vb{E} & = Z\sum_{l,m}\left( \frac{i}{k}a_{lm}\nabla\times\left(f_l(kr)\vb{X}_{lm}\right) + b_{lm}g_l(kr)\vb{X}_{lm} \right)                                                             \\
		       & = Z\sum_{l,m}\left( -\frac{a_{lm}\sqrt{l(l+1)}}{kr}f_l(kr)Y_{lm}\uv{r} + \frac{ia_{lm}}{kr}\frac{\dd(rf_l(kr))}{\dd r}\uv{r}\times\vb{X}_{lm} + b_{lm}g_l(kr)\vb{X}_{lm} \right). \\
		\vb{H} & = \sum_{l,m}\left( -\frac{i}{k}b_{lm}\nabla\times\left(g_l(kr)\vb{X}_{lm}\right) + a_{lm}f_l(kr)\vb{X}_{lm} \right)                                                             \\
		       & = \sum_{l,m}\left( -\frac{b_{lm}\sqrt{l(l+1)}}{kr}g_l(kr)Y_{lm}\uv{r} - \frac{ib_{lm}}{kr}\frac{\dd(rg_l(kr))}{\dd r}\uv{r}\times\vb{X}_{lm} + a_{lm}f_l(kr)\vb{X}_{lm} \right).
	\end{aligned}
\end{equation*}
其中，根据VSH的正交归一化性，也可以反解各项振幅得到
\begin{align*}
	a_{lm}f_l(kr) &= \int\vb{H}\cdot\vb{X}_{lm}^*\dd \Omega = -\frac{k}{Z\sqrt{l(l+1)}}\int\vb{r}\cdot\vb{E}Y_{lm}^*(\theta,\phi)\dd \Omega.\\
	b_{lm}g_l(kr) &= \frac{1}{Z}\int\vb{E}\cdot\vb{X}_{lm}^*\dd \Omega = \frac{k}{\sqrt{l(l+1)}}\int\vb{r}\cdot\vb{H}Y_{lm}^*(\theta,\phi)\dd \Omega.
\end{align*}

对于球对称体系，有限远处，能量辐射功率、电磁角动量辐射功率为：
\begin{align*}
	\frac{\dd P}{\dd \Omega} &= \frac{r^2}{2}\uv{r}\cdot\Re\left[\vb{E}\times\vb{H}^*\right] \\
	&= \frac{r^2}{2}\sum_{l,l',m,m'}\Re\left[ Z\left( a_{lm}a_{l'm'}^*\frac{1}{ikr}\frac{\dd(rf_l)}{\dd r}f_{l'}^* + b_{lm}b_{l'm'}^*\left( \frac{1}{ikr}\frac{\dd(rg_{l'})}{\dd r} \right)^*g_l \right)\vb{X}_{lm}\cdot\vb{X}_{l'm'}^* \right. \\
		&\quad + \left. Z\left( a_{l'm'}^*b_{lm}g_lf_{l'}^* - a_{lm}b_{l'm'}^*\left( \frac{1}{ikr}\frac{\dd(rg_{l'})}{\dd r} \right)^*\frac{1}{ikr}\frac{\dd(rf_l)}{\dd r} \right)\vb{X}_{lm}\times\vb{X}_{l'm'}^*\cdot\uv{r} \right] .\\
	P &= \int\frac{\dd P}{\dd \Omega}\dd \Omega = \frac{r^2}{2}\Re\left[ Z\sum_{l,m}\left( |a_{lm}|^2\frac{1}{ikr}\frac{\dd(rf_l)}{\dd r}f_l^* + |b_{lm}|^2\left( \frac{1}{ikr}\frac{\dd(rg_l)}{\dd r} \right)^*g_l \right) \right].\\
	\frac{\dd^2\vb{L}}{\dd t\,\dd \Omega} &= \frac{r^3}{2}\Re\left[ \varepsilon(\vb{E}\times\uv{r})(\uv{r}\cdot\vb{E}^*)+\mu(\vb{H}\times\uv{r})(\uv{r}\cdot\vb{H}^*) \right]\\
	&= \frac{r^2}{2}\Re \sum_{l,l',m,m'}\frac{Z\sqrt{l'(l'+1)}Y_{l'm'}^*}{\omega}\Bigg[\left( a_{lm}a_{l'm'}^* + b_{lm}b_{l'm'}^* \right)\vb{X}_{lm}   \\
		&\quad + \left( a_{l'm'}^*b_{lm}\frac{1}{ikr}\frac{\dd(rg_l)}{\dd r}f_{l'}^* - a_{lm}b_{l'm'}^*\frac{1}{ikr}\frac{\dd(rf_l)}{\dd r}g_{l'}^* \right)\uv{r}\times\vb{X}_{lm}  \Bigg].
\end{align*}
...
根据第一类球汉克尔函数的宗量渐进式
\begin{align*}
	h_l^{(1)}(x)\sim\frac{1}{ix}\frac{\dd(xh_l^{(1)}(x))}{\dd x}\sim\frac{(-i)^{l+1}e^{ix}}{x},\quad x\gg1.
\end{align*}
得到，在远场区域：
\begin{align*}
	...
	&\frac{\dd P_{sc}}{\dd \Omega} = \frac{Z_0}{2k_0^2}\left| \sum_{l,m}(-i)^{l+1}\left( -a_{lm}\uv{r}\times\vb{X}_{lm} + b_{lm}\vb{X}_{lm} \right) \right|^2,\quad P_{sc} = \frac{Z_0}{2k_0^2}\sum_{l,m}\left( |a_{lm}|^2 + |b_{lm}|^2 \right).\\
	&\frac{\dd^2\vb{L}_{sc}}{\dd t\dd \Omega} = \frac{Z_0}{2k_0^2\omega}\Re\left[ \sum_{l,l',m,m'}\sqrt{l'(l'+1)}Y_{l'm'}^*i^{l'-l}\left( \left( a_{lm}a_{l'm'}^* + b_{lm}b_{l'm'}^* \right)\vb{X}_{lm} + \left( a_{l'm'}^*b_{lm} - a_{lm}b_{l'm'}^* \right)\uv{r}\times\vb{X}_{lm} \right) \right]\\
	&\frac{\dd  \vb{L}_{sc}}{\dd t}\cdot\uv{z}= \int\frac{\dd^2\vb{L}_{\mathrm{sc}}}{\dd t\dd \Omega}\cdot\uv{z}\,\dd \Omega = \frac{Z_0}{2k_0^2\omega}\sum_{l,m}m\left(|a_{lm}|^2 + |b_{lm}|^2\right).
\end{align*}
...
按照前述的方法展开，振幅系数
\begin{align*}
	a_{lm}f_l(kr) & = \int\vb{H}_{\text{inc}}\cdot\vb{X}_{lm}^*\dd \Omega = i^{l-1}\sqrt{2\pi(2l+1)}(-A_-\delta_{m,-1}+A_+\delta_{m,1})\frac{E_{\text{inc}}}{Z_0}j_l(kr) = a_{l,\pm1}j_l(kr),         \\
	b_{lm}g_l(kr) & = \frac{1}{Z_0}\int\vb{E}_{\text{inc}}\cdot\vb{X}_{lm}^*\dd \Omega = i^l\sqrt{2\pi(2l+1)}(A_-\delta_{m,-1}+A_+\delta_{m,1})\frac{E_{\text{inc}}}{Z_0}j_l(kr) = b_{l,\pm1}j_l(kr).
\end{align*}
...
\begin{align*}
	P_{\text{abs}} = \frac{R^2}{2}\int\Re\left[-\uv{r}\cdot\left(\vb{E}_{\text{ext}}\times\vb{H}_{\text{ext}}^*\right)\right]_{r=R}\dd \Omega = \frac{\pi}{4k^2}\frac{E_{\text{inc}}^2}{Z_0}\sum_{\pm}\sum_{l=1}^{\infty}(2l+1)|A_{\pm}|^2\left(2-|1+\alpha_{l,\pm1}|^2-|1+\beta_{l,\pm1}|^2\right).
\end{align*}
其中，根据球贝塞尔函数的数学性质，结果恰与\(R\)无关.

散射体的散射功率为：
\begin{align*}
	\frac{\dd P_{\text{sc}}}{\dd \Omega} & = \frac{r^2}{2}\uv{r}\cdot\Re\left[\vb{E}_{\text{sc}}\times\vb{H}_{\text{sc}}^*\right]_{kr\gg1}  = \frac{\pi}{4k^2}\frac{E_{\text{inc}}^2}{Z_0}\left|\sum_{\pm}\sum_{l=1}^{\infty}\sqrt{2l+1}A_{\pm}\left(\alpha_{l,\pm1}\vb{X}_{l,\pm1}\pm i\beta_{l,\pm1}\uv{r}\times\vb{X}_{l,\pm1}\right)\right|^2, \\
	P_{\text{sc}}                      & = \int\frac{\dd P_{\text{sc}}}{\dd \Omega}\dd \Omega = \frac{\pi}{4k^2}\frac{E_{\text{inc}}^2}{Z_0}\sum_{\pm}\sum_{l=1}^{\infty}(2l+1)|A_{\pm}|^2\left(|\alpha_{l,\pm1}|^2+|\beta_{l,\pm1}|^2\right).
\end{align*}
...
\begin{align*}
	...
	\frac{\dd \sigma_{\text{sc}}}{\dd \Omega} & = \frac{\pi}{2k^2}\left|\sum_{\pm}\sum_{l=1}^{\infty}\sqrt{2l+1}A_{\pm}\left(\alpha_{l,\pm1}\vb{X}_{l,\pm1}\pm i\beta_{l,\pm1}\uv{r}\times\vb{X}_{l,\pm1}\right)\right|^2, \\
...
\begin{exbox}
	...
	\begin{align*}
		 ...
		 & \frac{\dd(krj_l(kr))}{\dd(kr)}\bigg|_{r=R}-\frac{\beta_{l,\pm1}}{2}\frac{\dd(krh_l^{(1)}(kr))}{\dd(kr)}\bigg|_{r=R} = \frac{1}{n}d_{l,\pm1}\frac{\dd(nkrj_l(nkr))}{\dd(nkr)}\bigg|_{r=R},      \\
		 & \frac{\dd(krj_l(kr))}{\dd(kr)}\bigg|_{r=R}+\frac{\alpha_{l,\pm1}}{2}\frac{\dd(krh_l^{(1)}(kr))}{\dd(kr)}\bigg|_{r=R} = \frac{1}{\mu_r}c_{l,\pm1}\frac{\dd(nkrj_l(nkr))}{\dd(nkr)}\bigg|_{r=R}.
	\end{align*}
	解得
	\begin{align*}
	...
	\begin{align*}
		...
		&J_l' = \left.\frac{\dd(krj_l(kr))}{\dd(kr)}\right|_{r=R},\quad
		N_l' = \left.\frac{\dd(krn_l(kr))}{\dd(kr)}\right|_{r=R},\quad
		\Pi_l' = \left.\frac{\dd(nkrj_l(nkr))}{\dd(nkr)}\right|_{r=R},\quad
		H_l' = J_l' + iN_l'.\\
	...
	\begin{align*}
		...
		\begin{cases}
			...
			{\big(\mu_r l+l+1\big)\,(2l+1)!!\,(2l-1)!!},
			 & kR\ll 1, \\[6pt]
			\displaystyle
			 -1+(-1)^l\exp\!\left(-2 i\,kR+2i\arctan\!\Big(z_r\tan\!\big(nkR-\frac{l\pi}{2}\big)\Big)\right),
			 & kR\gg 1,
		\end{cases}
	\end{align*}
	\begin{align*}
		...
		\begin{cases}
			...
			{\big(\varepsilon_r l+l+1\big)\,(2l+1)!!\,(2l-1)!!},
			 & kR\ll 1, \\[6pt]
			\displaystyle
			 -1+(-1)^l\exp\!\left(-2 i\,kR+2i\arctan\!\Big(\frac{1}{z_r}\tan\!\big(nkR-\frac{l\pi}{2}\big)\Big)\right),
			 & kR\gg 1.
		\end{cases}
	\end{align*}
\end{exbox}
...
\begin{exbox}
	...
	根据表面相对阻抗定义 \begin{align*}
		\uv{r} \times \left( \vb{E}_\text{ext}\big|_{R} \times \uv{r} \right) = \frac{z_s}{Z_0} \uv{r} \times \vb{H}_\text{ext}\big|_{R}
	\end{align*}
	得
	\begin{align*}
		j_l(kR)+\frac{\alpha_{l,\pm1}}{2}h_l^{(1)}(kR) & = i\frac{z_s}{kR}\frac{\dd(kr(j_l(kr)+\frac{\alpha_{l,\pm1}}{2}h_l^{(1)}(kr)))}{\dd(kr)}\bigg|_{r=R},     \\
		j_l(kR)+\frac{\beta_{l,\pm1}}{2}h_l^{(1)}(kR)  & = i\frac{z_s^{-1}}{kR}\frac{\dd(kr(j_l(kr)+\frac{\beta_{l,\pm1}}{2}h_l^{(1)}(kr)))}{\dd(kr)}\bigg|_{r=R}.
	\end{align*}
	...
	\begin{align*}
		\alpha_{l,\pm1}&=
		\begin{cases}
			-\dfrac{2i(kR)^{2l+1}}{(2l+1)!!\,(2l-1)!!}\dfrac{kR-i z_s(l+1)}{kR+i z_s l}, & kR\ll1, \\
			\dfrac{z_s-1}{z_s+1}(-1)^{l+1}e^{-2ikR}-1,                                   & kR\gg1.
		\end{cases}\\
		\beta_{l,\pm1}&=
		\begin{cases}
			-\dfrac{2i(kR)^{2l+1}}{(2l+1)!!\,(2l-1)!!}\dfrac{kR-i z_s^{-1}(l+1)}{kR+i z_s^{-1}l}, & kR\ll1, \\
...
\begin{exbox}
	...
	\begin{align*}
		...
		\frac{\dd \sigma_{\mathrm{sc}}}{\dd \Omega}
	...
	故
	\begin{align*}
		\vb{E}_{\rm sc} = -\dfrac{3}{4}i E_{\rm inc} \dfrac{e^{ikr}}{kr}\bigl(\beta(\uv{n}_s\times\uv{e}_i)\times\uv{n}_s + \alpha(\uv{n}_i\times\uv{e}_i)\times\uv{n}_s\bigr) = \dfrac{k^2 e^{ikr}}{4 \pi\varepsilon_0 r} E_{\rm inc}\bigl(\kappa_e (\uv{n}_s\times\uv{e}_i)\times\uv{n}_s +
		\kappa_m (\uv{n}_i\times\uv{e}_i)\times\uv{n}_s\bigr).
	\end{align*}
	其中
	\begin{align*}
		\kappa_e = \dfrac{3 \pi\varepsilon_0}{i k^3}\beta, \quad \kappa_m = \dfrac{3 \pi\varepsilon_0}{i k^3}\alpha.
	\end{align*}
	...
	\begin{align*}
		...
		\beta &= \beta_{1,\pm1} = \exp\Bigl[2i\arctan\Bigl(\dfrac{J_1\Pi_1'- \varepsilon_r \Pi_1 J_1'}{N_1\Pi_1'- \varepsilon_r \Pi_1 N_1'}\Bigr)\Bigr]_{kR\ll1}-1 = i\dfrac{4}{3}\dfrac{\varepsilon_r-1}{\varepsilon_r+2}(kR)^3.
	\end{align*}

	或者根据电磁学经典的结论得
	\begin{align*}
		\kappa_e = 4\pi \varepsilon_0 R^3 \dfrac{\varepsilon_r-1}{\varepsilon_r+2}, \quad \kappa_m = 4\pi \varepsilon_0 R^3 \dfrac{\mu_r-1}{\mu_r+2} \quad\implies\quad
		\alpha = i\dfrac{4}{3}\dfrac{\mu_r-1}{\mu_r+2}(kR)^3, \quad \beta = i\dfrac{4}{3}\dfrac{\varepsilon_r-1}{\varepsilon_r+2}(kR)^3.
	\end{align*}

	进而散射截面为
	\begin{align*}
		\frac{\dd \sigma_{\text{sc}}}{\dd \Omega} & = \frac{R^6k^4}{2}\left[(1+\cos^2\theta)\left(\left|\frac{\varepsilon_r-1}{\varepsilon_r+2}\right|^2+\left|\frac{\mu_r-1}{\mu_r+2}\right|^2\right)+2\sin^2\theta\frac{\nu}{1+\nu^2}\cos(\psi-2\phi)\left(-\left|\frac{\varepsilon_r-1}{\varepsilon_r+2}\right|^2+\left|\frac{\mu_r-1}{\mu_r+2}\right|^2\right)\right. \\
	...
	进而散射功率、吸收功率、总消耗功率为
	\begin{align*}
		\frac{\dd \sigma_{\text{sc}}}{\dd \Omega}&=\frac{R^6k^4}{8}\left[5(1+\cos^2\theta)\left(1-\frac{3\delta_c}{5R}\right)-6\sin^2\theta\frac{\nu}{1+\nu^2}\cos(\psi-2\phi)\left(1+\frac{\delta_c}{R}\right)-8\cos\theta\left(1-\frac{3\delta_c}{2R}\right)\right]\\
...
\begin{align*}
	\int_{-\infty}^{\infty} \int_0^{2\pi} \int_\rho \vb{L}_{mn} \cdot \vb{L}_{m'n'}^* \;/\; \vb{M}_{mn} \cdot \vb{M}_{m'n'}^* \;/\; \vb{N}_{mn} \cdot \vb{N}_{m'n'}^* \; \rho \,\dd \rho \,\dd \phi \,\dd z \propto \delta_{mm'}\delta_{nn'}.
\end{align*}

而同一模式下，\(\vb{M}_{mn}\) 和 \(\vb{N}_{mn}\) 的内积不一定为零，事实上
\begin{align*}
	 & \int_{-\infty}^{\infty} \int_0^{2\pi} \int_{\rho_{\min}}^{\rho_{\max}} \vb{L}_{mn} \cdot \vb{M}_{m'n'}^* \; \rho \,\dd \rho \,\dd \phi \,\dd z \\
	 & \quad \propto \delta_{mm'}\delta_{nn'} \, m \bigl( |Z_m(k_{\perp n}\rho_{\max})|^2 - |Z_m(k_{\perp n}\rho_{\min})|^2 \bigr),                \\
	 & \int_{-\infty}^{\infty} \int_0^{2\pi} \int_{\rho_{\min}}^{\rho_{\max}} \vb{M}_{mn} \cdot \vb{N}_{m'n'}^* \; \rho \,\dd \rho \,\dd \phi \,\dd z \\
...
\end{align*}
	...
	当 \(k_{z,n} = 0\) 时，\(\vb{M}_{mn}\) 和 \(\vb{N}_{mn}\) 模式是正交的，电磁场可以分解为 TE (\(E_z = 0\)) 和 TM (\(H_z = 0\)) 两个模式。两个模式的边界条件、辐射特征互不干扰，但在近场存在耦合。若采用实场的角向展开，实性条件对应 \(a_{-m}=a_m^*\)、\(b_{-m}=b_m^*\)，而不是一般的 \(a_{-m}=a_m\)、\(b_{-m}=b_m\)。为保留复振幅的通用性，以下暂不代入该条件。
...
进而圆柱的吸收功率为
\begin{align*}
	P_{\rm abs} = -\frac{R}{2} \uv{\rho} \cdot \int_0^{2\pi} \Re\bigl[ \vb{E}_{\rm ext} \times \vb{H}_{\rm ext}^* \bigr]_{\rho=R} \,\dd \phi = \frac{2E_{\rm inc}^2}{kZ_0} \sum_{m=-\infty}^{\infty} \bigl( \Re[A^{\rm TM*} a_{E,m} + A^{\rm TE*} a_{M,m}] - |a_{E,m}|^2 - |a_{M,m}|^2 \bigr),
\end{align*}
其中外部电磁场指
\begin{align*}
...
\begin{align*}
	\frac{\dd P_{\rm sc}}{\dd \phi}              & = \frac{\rho}{2} \uv{\rho} \cdot \Re\bigl[ \vb{E}_{\rm sc} \times \vb{H}_{\rm sc}^* \bigr] \Big|_{k\rho \gg 1}
	...
	P_{\rm sc}                                 & = \int_0^{2\pi} \frac{\dd P_{\rm sc}}{\dd \phi} \,\dd \phi
	= \frac{2E_{\rm inc}^2}{k Z_0} \sum_{m=-\infty}^{\infty} \bigl( |a_{E,m}|^2 + |a_{M,m}|^2 \bigr),                                                                                                                                                  \\
	\frac{\dd^2 \vb{L}_{\rm sc}}{\dd t\,\dd \phi} & = \frac{\rho^2}{2} \Re\bigl[ \varepsilon_0 (\vb{E}_{\rm sc} \times \uv{\rho})(\uv{\rho} \cdot \vb{E}_{\rm sc}^*) + \mu_0 (\vb{H}_{\rm sc} \times \uv{\rho})(\uv{\rho} \cdot \vb{H}_{\rm sc}^*) \bigr] \\
	...
	\frac{\dd \vb{L}_{\rm sc}}{\dd t}            & = \int_0^{2\pi} \frac{\dd^2 \vb{L}_{\rm sc}}{\dd t\,\dd \phi} \,\dd \phi
...
\begin{align*}
	...
	\frac{\dd \sigma_{\rm sc}}{\dd \phi} & = \frac{2}{\pi k} \left( \Bigl| \sum_{m=-\infty}^{\infty} e^{im\phi} a_{E,m} \Bigr|^2 + \Bigl| \sum_{m=-\infty}^{\infty} e^{im\phi} a_{M,m} \Bigr|^2 \right), \\
	\sigma_{\rm sc}                    & = \int_0^{2\pi} \frac{\dd \sigma_{\rm sc}}{\dd \phi} \,\dd \phi
...
\begin{exbox}
	...
	散射截面项可化简为
	\begin{align*}
		\frac{\dd \sigma_{\mathrm{sc}}}{\dd \phi} &= \frac{2}{\pi k}\Bigl(|a_{E,0}|^{2}+|a_{M,0}|^{2}+4\bigl(|a_{E,1}|^{2}+|a_{M,1}|^{2}\bigr)\cos^{2}\phi + 4\cos\phi\,\Re\bigl(a_{E,0}a_{E,1}^{*}+a_{M,0}a_{M,1}^{*}\bigr)\Bigr) \\&= \frac{k^{3}}{8\pi\varepsilon_{0}^{2}}\Bigl|\bigl(\uv{n}_{s}\times(\vb{\kappa}_{e}\cdot\uv{e}_{i})\bigr)\times\uv{n}_{s} + \bigl(\vb{\kappa}_{m}\cdot(\uv{n}_{i}\times\uv{e}_{i})\bigr)\times\uv{n}_{s}\Bigr|^{2}.\\
	...
	\begin{align*}
		...
		\frac{\dd \sigma_{\mathrm{sc}}}{\dd \phi} &= \frac{\pi k^{3} R^{4}}{8} \left[ |A^{\mathrm{TM}}|^{2} \left( |\varepsilon_{r} - 1|^{2} + 4 \cos^{2}\phi \left| \frac{\mu_{r} - 1}{\mu_{r} + 1} \right|^{2} \right) + |A^{\mathrm{TE}}|^{2} \left( |\mu_{r} - 1|^{2} + 4 \cos^{2}\phi \left| \frac{\varepsilon_{r} - 1}{\varepsilon_{r} + 1} \right|^{2} \right) \right. \\
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_small_sphere_x_direction_real_part.png}
			\caption{有损小球，\(x\)方向实部}
			\label{fig:sphere_scat_small_lossy_x}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_small_sphere_y_direction_real_part.png}
			\caption{有损小球，\(y\)方向实部}
			\label{fig:sphere_scat_small_lossy_y}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_small_sphere_z_direction_real_part.png}
			\caption{有损小球，\(z\)方向实部}
			\label{fig:sphere_scat_small_lossy_z}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_small_sphere_amplitude_magnitude.png}
			\caption{有损小球，振幅大小}
			\label{fig:sphere_scat_small_lossy_amp}
		\end{subfigure}
		...
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_large_sphere_x_direction_real_part.png}
			\caption{有损大球，\(x\)方向实部}
			\label{fig:sphere_scat_large_lossy_x}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_large_sphere_y_direction_real_part.png}
			\caption{有损大球，\(y\)方向实部}
			\label{fig:sphere_scat_large_lossy_y}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_large_sphere_z_direction_real_part.png}
			\caption{有损大球，\(z\)方向实部}
			\label{fig:sphere_scat_large_lossy_z}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_large_sphere_amplitude_magnitude.png}
			\caption{有损大球，振幅大小}
			\label{fig:sphere_scat_large_lossy_amp}
		\end{subfigure}
		...
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossless_large_sphere_x_direction_real_part.png}
			\caption{无损大球，\(x\)方向实部}
			\label{fig:sphere_scat_large_lossless_x}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossless_large_sphere_y_direction_real_part.png}
			\caption{无损大球，\(y\)方向实部}
			\label{fig:sphere_scat_large_lossless_y}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
% [TODO: missing figure] 			\includegraphics[width=\linewidth]{lossless_large_sphere_z_direction_real_part.png}
			\caption{无损大球，\(z\)方向实部}
			\label{fig:sphere_scat_large_lossless_z}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossless_large_sphere_amplitude_magnitude.png}
			\caption{无损大球，振幅大小}
			\label{fig:sphere_scat_large_lossless_amp}
		\end{subfigure}

		\caption{球体散射振幅比较图（对比有无损耗及不同半径）}
		\label{fig:sphere_scat_comparison}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{0.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_small_sphere.png}
			\caption{有损小球}
			\label{fig:sphere_total_small_lossy}
		\end{subfigure}
		\hfill
		% 第二个：有损大球总场振幅
		\begin{subfigure}{0.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_large_sphere.png}
			\caption{有损大球}
			\label{fig:sphere_total_large_lossy}
		\end{subfigure}
		\hfill
		% 第三个：无损大球总场振幅
		\begin{subfigure}{0.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossless_large_sphere.png}
			\caption{无损大球}
			\label{fig:sphere_total_large_lossless}
		\end{subfigure}

		\caption{球体总场振幅比较图（对比有无损耗及不同半径）}
		\label{fig:sphere_total_comparison}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_small_cylinder_x_direction_real_part.png}
			\caption{有损小柱，\(x\)方向实部}
			\label{fig:cyl_scat_small_lossy_x}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_small_cylinder_y_direction_real_part.png}
			\caption{有损小柱，\(y\)方向实部}
			\label{fig:cyl_scat_small_lossy_y}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_small_cylinder_z_direction_real_part.png}
			\caption{有损小柱，\(z\)方向实部}
			\label{fig:cyl_scat_small_lossy_z}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_small_cylinder_amplitude_magnitude.png}
			\caption{有损小柱，振幅大小}
			\label{fig:cyl_scat_small_lossy_amp}
		\end{subfigure}
		...
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_large_cylinder_x_direction_real_part.png}
			\caption{有损大柱，\(x\)方向实部}
			\label{fig:cyl_scat_large_lossy_x}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_large_cylinder_y_direction_real_part.png}
			\caption{有损大柱，\(y\)方向实部}
			\label{fig:cyl_scat_large_lossy_y}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_large_cylinder_z_direction_real_part.png}
			\caption{有损大柱，\(z\)方向实部}
			\label{fig:cyl_scat_large_lossy_z}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_large_cylinder_amplitude_magnitude.png}
			\caption{有损大柱，振幅大小}
			\label{fig:cyl_scat_large_lossy_amp}
		\end{subfigure}
		...
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossless_large_cylinder_x_direction_real_part.png}
			\caption{无损大柱，\(x\)方向实部}
			\label{fig:cyl_scat_large_lossless_x}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossless_large_cylinder_y_direction_real_part.png}
			\caption{无损大柱，\(y\)方向实部}
			\label{fig:cyl_scat_large_lossless_y}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossless_large_cylinder_z_direction_real_part.png}
			\caption{无损大柱，\(z\)方向实部}
			\label{fig:cyl_scat_large_lossless_z}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.235\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossless_large_cylinder_amplitude_magnitude.png}
			\caption{无损大柱，振幅大小}
			\label{fig:cyl_scat_large_lossless_amp}
		\end{subfigure}

		\caption{柱体散射振幅比较图（对比有无损耗及不同半径）}
		\label{fig:cyl_scat_comparison}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{0.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_small_cylinder.png}
			\caption{有损小柱}
			\label{fig:cyl_total_small_lossy}
		\end{subfigure}
		\hfill
		% 第二个：有损大柱总场振幅
		\begin{subfigure}{0.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossy_large_cylinder.png}
			\caption{有损大柱}
			\label{fig:cyl_total_large_lossy}
		\end{subfigure}
		\hfill
		% 第三个：无损大柱总场振幅
		\begin{subfigure}{0.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{lossless_large_cylinder.png}
			\caption{无损大柱}
			\label{fig:cyl_total_large_lossless}
		\end{subfigure}

		\caption{柱体总场振幅比较图（对比有无损耗及不同半径）}
		\label{fig:cyl_total_comparison}
