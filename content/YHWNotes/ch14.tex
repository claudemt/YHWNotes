...
\begin{align*}
	\oint_{\partial V} \frac{1}{2}\Re (\vb{E}\times\vb{H}^*)\cdot\dd \vb{S} = -\int_V \frac{1}{2}\Re(\vb{E}\cdot\vb{J}^*)\dd V - \omega\int_V \frac{1}{2}\Im (\vb{H}^*\cdot\vb{B} - \vb{E}\cdot\vb{D}^*)\dd V.
\end{align*}
之中，介质损耗功率体密度为零
\begin{align*}
...
\begin{figure}[htbp]
	\begin{minipage}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{electromagnetic_field_vectors_in_crystal.png}
		\caption{晶体内的电磁场矢量}
		\label{fig:em_field_vectors_in_crystal}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{conical_refraction_schematic_diagram.png}
		\caption{锥形折射示意图}
		\label{fig:conical_refraction}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.3\textwidth}
		\centering
		\centering
		\includegraphics[width=\textwidth]{interference_setup_schematic_diagram.png}
		\caption{干涉装置示意图}
		\label{fig:crystal_interference_setup}
		\label{fig:uniaxial_crystal_interference}
	\end{minipage}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.24\textwidth}
		\includegraphics[width=\textwidth]{birefringent_refraction_case_1.png}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.24\textwidth}
		\includegraphics[width=\textwidth]{birefringent_refraction_case_2.png}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.25\textwidth}
		\includegraphics[width=\textwidth]{birefringent_refraction_case_3.png}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.25\textwidth}
		\includegraphics[width=\textwidth]{birefringent_refraction_case_4.png}
	\end{subfigure}
	\caption{算例的四种出射入射方式}
	\label{fig:four_incident_exit_configs}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.33\textwidth}
		\includegraphics[width=\textwidth]{first_extinction_case_left_panel.png}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.32\textwidth}
		\includegraphics[width=\textwidth]{first_extinction_case_middle_panel.png}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.33\textwidth}
		\includegraphics[width=\textwidth]{first_extinction_case_right_panel.png}
	\end{subfigure}
	\caption{第一类消光情形}
	\label{fig:extinction_type_i}
\end{figure}

如\cref{fig:extinction_type_i}，该情形可消光，则：
\begin{align*}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{0.33\textwidth}
		\includegraphics[width=\textwidth]{second_extinction_case_left_panel.png}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.32\textwidth}
		\includegraphics[width=\textwidth]{second_extinction_case_middle_panel.png}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.33\textwidth}
		\includegraphics[width=\textwidth]{second_extinction_case_right_panel.png}
	\end{subfigure}
	\caption{第二类消光情形}
	\label{fig:extinction_type_ii}
\end{figure}

如\cref{fig:extinction_type_ii}，该情形可消光，则：
\begin{align*}
...
注意到 \(R_L' = r_R^2 \dfrac{\cos\theta_r}{\cos\theta_r'}\)，故 \begin{align*}
...
进而可通过偏振片、凸透镜使之同方向并汇聚干涉（如\cref{fig:uniaxial_crystal_interference}）.
