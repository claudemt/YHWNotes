...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{square_and_circular_aperture_spectrum_comparison_plot.png}
	\caption{方孔圆孔频谱比较图}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.75\textwidth]{four_f_system_schematic_diagram.png}
	\caption{4\(f\)系统示意图}
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{single_rectangular_aperture.png}
		\caption{单长方孔}
	...
	\hfill
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{double_rectangular_aperture.png}
		\caption{双长方孔}
	...
	\vspace{0.1cm}
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{pentagram_aperture.png}
		\caption{五角星孔}
	...
	\hfill
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{isosceles_triangle_aperture.png}
		\caption{等腰三角形孔}
	...
	\vspace{0.1cm}
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{single_circular_aperture.png}
		\caption{单圆孔}
	...
	\hfill
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{double_circular_aperture.png}
		\caption{双圆孔}
	...
	\vspace{0.1cm}
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{five_slits.png}
		\caption{五缝}
	...
	\hfill
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{three_slits.png}
		\caption{三缝}
	...
	\vspace{0.1cm}
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{cubic_close_packed_square_aperture.png}
		\caption{立方密排方孔}
	...
	\hfill
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{hexagonal_close_packed_square_aperture.png}
		\caption{六角密排方孔}
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{cubic_close_packed_circular_aperture.png}
		\caption{立方密排圆孔}
		\label{fig:object_spectrum_cubic_circle}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{hexagonal_close_packed_circular_aperture.png}
		\caption{六角密排圆孔}
	...
	\vspace{0.1cm}
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{cross_aperture.png}
		\caption{“十”字孔}
		\label{fig:object_spectrum_cross}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{two_dimensional_grating.png}
		\caption{二维光栅}
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{0.24\textwidth}
		\includegraphics[width=\textwidth]{cross_aperture_zero_order_blocked.png}
		\caption{“十”字挡零级}
		\label{fig:filtered_image_cross_block_zero}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.24\textwidth}
		\includegraphics[width=\textwidth]{single_rectangular_aperture_zero_order_blocked.png}
		\caption{单长方孔挡零级}
		\label{fig:filtered_image_rect_block_zero}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.24\textwidth}
		\includegraphics[width=\textwidth]{two_dimensional_grating_through_vertical_slit.png}
		\caption{二维光栅过正狭缝}
		\label{fig:filtered_image_grating_vertical_slit}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.24\textwidth}
		\includegraphics[width=\textwidth]{two_dimensional_grating_through_oblique_slit.png}
		\caption{二维光栅过斜狭缝}
