...
\begin{align*}
	\vb{E}' & = Z_0 \sum_{l,m} \left( \frac{i}{k} a_{lm} \nabla \times \left( f_l(kr) \vb{X}_{lm} \right) + b_{lm} g_l(kr) \vb{X}_{lm} \right)                                                       \\
	        & = Z_0 \sum_{l,m} \left( -\frac{a_{lm}}{k r} \sqrt{l(l+1)} f_l(kr) Y_{lm} \uv{r} - a_{lm} \frac{\dd(r f_l(kr))}{ikr\dd r} \uv{r} \times \vb{X}_{lm} + b_{lm} g_l(kr) \vb{X}_{lm} \right), \\
	\vb{H}' & = \sum_{l,m} \left( -\frac{i}{k} b_{lm} \nabla \times \left( g_l(kr) \vb{X}_{lm} \right) + a_{lm} f_l(kr) \vb{X}_{lm} \right)                                                          \\
	        & = \sum_{l,m} \left( -\frac{b_{lm}}{k r} \sqrt{l(l+1)} g_l(kr) Y_{lm} \uv{r} -  b_{lm} \frac{\dd(r g_l(kr))}{ikr\dd r} \uv{r} \times \vb{X}_{lm} + a_{lm} f_l(kr) \vb{X}_{lm} \right).
\end{align*}
其中 \(f_l(kr), g_l(kr)\) 满足 \(l\) 阶球贝塞尔方程，各阶展开振幅为：
\begin{align*}
	a_{lm} f_l(kr) &= \int \vb{H}' \cdot \vb{X}_{lm}^\ast \dd \Omega = -\frac{k}{Z_0 \sqrt{l(l+1)}} \int \vb{r} \cdot \vb{E}'\, Y_{lm}^\ast (\theta, \phi) \dd \Omega,\\
	b_{lm} g_l(kr) &=\frac{1}{Z_0} \int \vb{E}' \cdot \vb{X}_{lm}^\ast \dd \Omega = \frac{k}{\sqrt{l(l+1)}} \int \vb{r} \cdot \vb{H}'\, Y_{lm}^\ast (\theta, \phi) \dd \Omega.
\end{align*}

运用数学公式于辐射区（\(r = r_> > r' = r_<\)）
\begin{align*}
	&\frac{1}{4 \pi} \int Y_{lm}^\ast (\theta, \phi) \frac{e^{i k |\vb{r} - \vb{r}'|}}{|\vb{r} - \vb{r}'|} \dd \Omega = i k h_l^{(1)}(k r_>) j_l(k r_<) Y_{lm}^\ast (\theta', \phi').\\
...
\begin{align*}
	...
	&a_{lm} = \frac{k^2}{\sqrt{l(l+1)}} \int_{V_s} Y_{lm}^\ast (\theta, \phi) \left[ -k j_l(kr) \nabla \cdot (\vb{r} \times \vb{M}) - \frac{\dd(r j_l(kr))}{k \dd r} \nabla \cdot \vb{J} + k j_l(kr) \vb{r} \cdot \vb{J} \right] \dd \vb{r},\\
	&b_{lm} = \frac{k^2}{i \sqrt{l(l+1)}} \int_{V_s} Y_{lm}^\ast (\theta, \phi) \left[ j_l(kr) \nabla \cdot (\vb{r} \times \vb{J}) + \frac{\dd(r j_l(kr))}{\dd r} \nabla \cdot \vb{M} - k^2 j_l(kr) \vb{r} \cdot \vb{M} \right] \dd \vb{r}.
\end{align*}
...
其中
\begin{align*}
	Q_{lm} = \int r^l Y_{lm}^\ast \rho \dd \vb{r} = \frac{-i}{k c} \int r^l Y_{lm}^\ast \nabla \cdot \vb{J} \dd \vb{r},\quad
	Q_{lm}' = \frac{-i k}{(l+1) c} \int r^l Y_{lm}^\ast \nabla \cdot (\vb{r} \times \vb{M}) \dd \vb{r},
\end{align*}
\begin{align*}
	M_{lm} = -\frac{1}{l+1} \int r^l Y_{lm}^\ast \nabla \cdot (\vb{r} \times \vb{J}) \dd \vb{r},\quad
	M_{lm}' = -\int r^l Y_{lm}^\ast \nabla \cdot \vb{M} \dd \vb{r}.
\end{align*}

远场只保留 Hankel 函数的 \(1/r\) 出射部分：
\begin{align*}
	h_l^{(1)}(kr)\sim (-i)^{l+1}\frac{e^{ikr}}{kr},\qquad
	\frac{\dd (r h_l^{(1)})}{\dd r}\sim i k r h_l^{(1)} .
\end{align*}
...
\begin{align*}
	\frac{\dd P_{\text{rad}}(\omega)}{\dd \Omega} = \frac{Z_0}{2k^2} \left| \sum_{l,m}(-i)^{l+1} \left( a_{lm} \vb{X}_{lm} + b_{lm} \uv{r} \times \vb{X}_{lm} \right) \right|^2,\quad
	P_{\text{rad}}(\omega) = \frac{Z_0}{2k^2} \sum_{l,m} \left( |a_{lm}|^2 + |b_{lm}|^2 \right).
\end{align*}

角动量辐射功率的微分表达式为：
\begin{align*}
	\frac{\dd^2 \vb{L}_{\text{rad}}(\omega)}{\dd t \, \dd \Omega} = \frac{Z_0}{2k^3 c} \, \text{Re} \left[ \sum_{l,l',m,m'} \sqrt{l'(l' + 1)} \, Y_{l'm'}^\ast \, i^{l' - l}\left( \left( a_{lm} a_{l'm'}^\ast + b_{lm} b_{l'm'}^\ast \right) \vb{X}_{lm} + \left( a_{l'm'}^\ast b_{lm} - a_{lm} b_{l'm'}^\ast \right) \uv{r} \times \vb{X}_{lm}	\right) \right].
\end{align*}
...
\begin{exbox}
	...
	进而 \(b_{lm} = 0\),
	\begin{align*}
		a_{lm} & = \frac{k^2}{2\pi\sqrt{l(l+1)}} \int_0^{d/2} \left( k r j_l(kr) I(r) - \frac{1}{k} \frac{\dd I(r)}{\dd r} \frac{\dd(r j_l(kr))}{\dd r} \right) \dd r \int \left[ Y_{lm}^\ast [\delta(\cos\theta - 1) - \delta(\cos\theta + 1)] \right] \dd \Omega \\
		       & = \frac{k(1 - (-1)^l)}{2} \delta_{m0} \sqrt{\frac{2l+1}{\pi l(l+1)}} \int_0^{d/2} \left[ -\frac{\dd}{\dd r}\left( r j_l(kr) \frac{\dd I}{\dd r} \right) + r j_l(kr) \left( k^2 I + \frac{\dd^2 I}{\dd r^2} \right) \right] \dd r.
	\end{align*}
	...
	\begin{align*}
		\vb{E}_{\text{rad}} &= i Z_0 \frac{I e^{i k r}}{2 \pi r} \uv{\theta}\sum_{n=1}^\infty \left( \frac{4n-1}{4n(2n-1)} k d \,j_{2n-1} \left( \frac{k d}{2} \right) (-1)^n \frac{\dd\, P_{2n-1} (\cos \theta)}{\dd\,\theta} \right)
	...
	辐射功率及辐射相对阻抗为：
	\begin{align*}
		&\dfrac{\dd  P_{\text{rad}}}{\dd  \Omega} = Z_0 \dfrac{I^2}{8 \pi^2} \left( \dfrac{\cos \left( \dfrac{k d}{2} \cos \theta \right) - \cos \left( \dfrac{k d}{2} \right)}{\sin \theta} \right)^2,\quad
		P_{\text{rad}} = \dfrac{Z_0 I^2}{4 \pi} \int_0^\pi \dfrac{\left( \cos \left( \dfrac{k d}{2} \cos \theta \right) - \cos \left( \dfrac{k d}{2} \right) \right)^2}{\sin \theta} \dd \theta,\\
		&z_{\text{rad}} = \dfrac{2 P_{\text{rad}}}{I^2 Z_0} = \dfrac{1}{2 \pi} \int_0^\pi \dfrac{\left( \cos \left( \dfrac{k d}{2} \cos \theta \right) - \cos \left( \dfrac{k d}{2} \right) \right)^2}{\sin \theta} \dd \theta.
	\end{align*}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[b]{0.5\textwidth}
			\includegraphics[width=\textwidth]{energy_angular_distribution.png}
			\caption{能量角分布}
			\label{fig:dipole_antenna_angular_power}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.48\textwidth}
			\includegraphics[width=\textwidth]{relative_impedance.png}
			\caption{相对阻抗}
			\label{fig:dipole_antenna_impedance}
		\end{subfigure}

		\caption{正弦天线的辐射}
		\label{fig:dipole_antenna_radiation}
	\end{figure}
\end{exbox}
...
\begin{align*}
	\Phi = \dfrac{1}{4\pi \varepsilon_0} \int \dfrac{\rho\left( \vb{r}', t - \dfrac{|\vb{r} - \vb{r}'|}{c} \right)}{|\vb{r} - \vb{r}'|} \dd \vb{r}',\quad
	\vb{A} = \dfrac{\mu_0}{4\pi} \int \dfrac{\vb{J}\left( \vb{r}', t - \dfrac{|\vb{r} - \vb{r}'|}{c} \right)}{|\vb{r} - \vb{r}'|} \dd \vb{r}'.
\end{align*}
...
\begin{align*}
	\dd \left( \vb{r}' - \vb{r}_q\left( t - \dfrac{|\vb{r} - \vb{r}'|}{c} \right) \right) &= \det \left( \nabla' \left( \vb{r}' - \vb{r}_q\left( t - \dfrac{|\vb{r} - \vb{r}'|}{c} \right) \right) \right) \dd \vb{r}' \\
	&= \left( 1 - \dfrac{(\vb{r} - \vb{r}') \cdot \dfrac{\dd \vb{r}_q(\tau)}{\dd \tau}}{c |\vb{r} - \vb{r}'|} \bigg|_{\tau = t - |\vb{r} - \vb{r}'|/c} \right) \dd \vb{r}'.
\end{align*}
...
\begin{align*}
	\vb{v} = \dfrac{\dd \vb{r}_q(\tau)}{\dd \tau} \bigg|_{\tau = t_s},\quad
	\vb{a} = \dfrac{\dd^2\vb{r}_q(\tau)}{\dd \tau^2} \bigg|_{\tau = t_s},\quad
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{0.24\textwidth}
		\includegraphics[width=\textwidth]{charge_uniform_motion_radiation_schematic.png}
		\caption{匀速运动}
		\label{fig:charge_motion_uniform}
		\label{fig:uniform_motion_radiation}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.28\textwidth}
		\includegraphics[width=\textwidth]{charge_nonuniform_motion_radiation_schematic.png}
		\caption{非匀速运动}
		\label{fig:charge_motion_nonuniform}
		\label{fig:nonuniform_motion_radiation}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.25\textwidth}
		\includegraphics[width=\textwidth]{charge_circular_motion_radiation_schematic.png}
		\caption{圆周运动}
		\label{fig:charge_motion_circular}
		\label{fig:circular_motion_radiation}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.17\textwidth}
		\includegraphics[width=\textwidth]{charge_harmonic_motion_radiation_schematic.png}
		\caption{简谐运动}
		\label{fig:charge_motion_harmonic}
		\label{fig:harmonic_motion_radiation}
	\end{subfigure}
	\caption{电荷运动模式示意图}
	\label{fig:charge_motion_modes}
\end{figure}

如\cref{fig:uniform_motion_radiation}，记 \(\vb{v}\) 与 \(\vb{r}\) 的夹角为 \(\theta\)，\(|\vb{v}| = \beta c\)，则 \(\vb{R} = \vb{r} + R \vb{v}/c\)，解得：
\begin{align*}
...
\begin{align*}
	\mathcal{E}_{\text{detector}} = \int_{t = \tau_1 + |\vb{r} - \vb{r}_q(\tau_1)|/c}^{t = \tau_2 + |\vb{r} - \vb{r}_q(\tau_2)|/c} \vb{S} \cdot \uv{R} \, \dd t = \int_{\tau = \tau_1}^{\tau = \tau_2} \vb{S} \cdot \uv{R} \dfrac{\dd t}{\dd \tau} \dd \tau.
\end{align*}
显然，更有物理意义的辐射功率密度为 \(\vb{\mathcal{P}}_{\text{rad}}(\vb{r}, t) = \vb{S} \cdot \uv{R} \dd t/\dd \tau\).令加速时间无穷短，得辐射功率关于源处立体角的角分布：
\begin{align*}
	\dfrac{\dd P}{\dd \Omega} = R^2 \vb{S} \cdot \uv{R} \dfrac{\partial t}{\partial t_s} = \dfrac{q^2}{16\pi^2 \varepsilon_0 \kappa^5 c^3} \left| \uv{R} \times \left( \left( \uv{R} - \dfrac{\vb{v}}{c} \right) \times \vb{a} \right) \right|^2.
\end{align*}
如\cref{fig:nonuniform_motion_radiation}，记 \(\uv{R}\) 与 \(\vb{v} = \vb{\beta} c\) 的夹角为 \(\theta\)（注意，\(\theta\) 不同于点电荷做匀速运动时的定义），在源处建立球坐标系，令 \(z\) 轴平行于 \(\vb{\beta}\)，适当选取零点使 \(\vb{a}\) 恰在 \(\phi = 0\) 平面内，则：
\begin{align*}
...
\begin{align*}
	\dfrac{\dd P}{\dd \Omega} &= \dfrac{q^2}{16\pi^2 \varepsilon_0 \kappa^5 c} \left| \uv{R} \times \left( \left( \uv{R} - \vb{\beta} \right) \times \dot{\vb{\beta}} \right) \right|^2 \\
...
\begin{align*}
	P = \int \dfrac{\dd P}{\dd \Omega} \dd \Omega = \dfrac{q^2 \gamma^6}{6\pi \varepsilon_0 c} \left( |\dot{\vb{\beta}}|^2 - |\vb{\beta} \times \dot{\vb{\beta}}|^2 \right).
\end{align*}
...
\begin{align*}
	\vb{E}(\vb{r}, \omega) &= \frac{q}{4\pi \varepsilon_{0} c r} \frac{1}{\sqrt{2\pi}} \int \frac{\uv{R} \times \left( (\uv{R} - \vb{\beta}) \times \dot{\vb{\beta}} \right)}{(1 - \uv{R} \cdot \vb{\beta})^{3}} e^{i\omega t} \, \dd t \quad= \frac{q}{4\pi \varepsilon_{0} c r} \frac{1}{\sqrt{2\pi}} \int e^{i\omega (t_{s} + R/c)} \frac{\uv{R} \times \left( (\uv{R} - \vb{\beta}) \times \dot{\vb{\beta}} \right)}{(1 - \uv{R} \cdot \vb{\beta})^{2}} \, \dd t_{s} \\
	&= -\frac{q e^{i\omega r/c}}{4\pi \varepsilon_{0} c r} \frac{i\omega}{\sqrt{2\pi}} \int_{-\infty}^{\infty} e^{i\omega \left( t_{s} - \uv{R} \cdot \vb{r}_{q}(t_{s})/c \right)} \uv{R} \times (\uv{R} \times \vb{\beta}) \, \dd t_{s}.
\end{align*}
式中用到
\begin{align*}
...
进而辐射功率角分布频谱为
\begin{align*}
	\frac{\dd^{2} W_{\mathrm{rad}}}{\dd \Omega \dd \omega} = 2 r^{2} \sqrt{\frac{\varepsilon_{0}}{\mu_{0}}} | \vb{E}(\vb{r}, \omega) |^{2} = \frac{q^{2} \omega^{2}}{16\pi^{3} \varepsilon_{0} c} \left| \int_{-\infty}^{\infty} e^{i\omega \left( t_{s} - \uv{R} \cdot \vb{r}_{q}(t_{s})/c \right)} \uv{R} \times \left( \uv{R} \times \vb{\beta} \right) \, \dd t_{s} \right|^{2}.
\end{align*}

特别注意，对于周期运动，频域辐射场将呈现分立的\(\delta\)函数谱，此时只能求出单个周期内总的辐射能量，积分时应采用如下约定
\begin{align*}
	\int_{0}^{\infty} \left( \delta(\omega - m \Omega) \right)^{2} f(m) \, \dd \omega = f(\omega/\Omega) \frac{T_{\mathrm{period}}}{2\pi}.
\end{align*}

下考虑圆周运动、简谐运动的辐射频谱.

\begin{exbox}
	半径为 \(a\) 的圆周运动，如\cref{fig:circular_motion_radiation}.
	\begin{align*}
	...
	\begin{align*}
		...
		\frac{\dd^{2} W_{\mathrm{rad}}}{\dd \Omega \dd \omega} &= \frac{q^{2} \omega^{2} \beta^{2}}{4\pi \varepsilon_{0} c} \left( \left| \sum_{m=-\infty}^{\infty} \delta\left( \omega - m \frac{\beta c}{a} \right) J_{m}'\left( \frac{\omega a \cos\theta}{c} \right) \right|^{2} + \left| \sum_{m=-\infty}^{\infty} \delta\left( \omega - m \frac{\beta c}{a} \right) m \sin\theta \frac{J_{m}\left(\omega a \cos\theta/c \right)}{\omega a \cos\theta/c} \right|^{2} \right). \\
		\frac{\dd  W_{\mathrm{rad}}}{\dd \Omega} &= \int_{0}^{\infty} \frac{\dd^{2} W_{\mathrm{rad}}}{\dd \Omega \dd \omega} \, \dd \omega = \frac{q^{2} \beta^{3}}{4\pi \varepsilon_{0} a} \sum_{m=1}^{\infty} m^{2} \left[ \left( J_{m}'(m\beta \cos\theta) \right)^{2} + m^{2} \sin^{2}\theta \left( \frac{J_{m}(m\beta \cos\theta)}{m\beta \cos\theta} \right)^{2} \right] \\
		&= \frac{q^{2} \beta^{3}}{64\pi \varepsilon_{0} a} \frac{4(1 + \sin^{2}\theta) - \beta^{2} \cos^{4}\theta (1 + 3\beta^{2})}{(1 - \beta^{2} \cos^{2}\theta)^{7/2}}. \\
		W_{\mathrm{rad}} &= 2\pi \int_{-\pi/2}^{\pi/2} \frac{\dd  W_{\mathrm{rad}}}{\dd \Omega} \cos\theta \, \dd \theta = \frac{q^{2} \gamma^{4} \beta^{3}}{3 \varepsilon_{0} a}.
	\end{align*}
	...
	得到
	\begin{align*}
		\frac{\dd^{2} W_{\mathrm{rad}}}{\dd \Omega \dd \omega} &= \frac{q^{2}}{12\pi^{3} \varepsilon_{0} c} \left( \frac{\omega a}{c} \right)^{2} (\theta^{2} + \gamma^{-2})^{2} \left( (K_{2/3}(\xi))^{2} + \frac{\theta^{2}}{\theta^{2} + \gamma^{-2}} (K_{1/3}(\xi))^{2} \right). \\
		\frac{\dd  W_{\mathrm{rad}}}{\dd \Omega} &= \frac{7 q^{2}}{64\pi \varepsilon_{0} a (\theta^{2} + \gamma^{-2})^{5/2}} \left( 1 + \frac{5}{7} \frac{\theta^{2}}{\theta^{2} + \gamma^{-2}} \right). \\
		W_{\mathrm{rad}} &= 2\pi \int_{-\infty}^{\infty} \frac{\dd  W_{\mathrm{rad}}}{\dd \Omega} \, \dd \theta = \frac{q^{2} \gamma^{4}}{3 \varepsilon_{0} a}.
	\end{align*}
\end{exbox}

\begin{exbox}
	幅度为\(a\)、角频率为\(\omega_{0}\) 的简谐运动，如\cref{fig:harmonic_motion_radiation}.
	\begin{align*}
	...
	代入得
	\begin{align*}
		\vb{E}(\vb{r}, \omega) &= i \uv{e}_{a} \frac{q \omega \omega_{0} a e^{i\omega r/c}}{4\pi \varepsilon_{0} c^{2} r} \frac{1}{\sqrt{2\pi}} \int_{-\infty}^{\infty} e^{i\omega \left( t_{s} - a \cos(\omega_{0} t_{s}) \cos\theta/c \right)} \sin\theta \sin(\omega_{0} t_{s}) \, \dd t_{s} \\
		...
		\frac{\dd^{2} W_{\mathrm{rad}}}{\dd \Omega \dd \omega} &= \frac{q^{2} \omega^{2}}{4\pi \varepsilon_{0} c} \tan^{2}\theta \left| \sum_{m=1}^{\infty} J_{m}(m\beta_{0} \cos\theta) \delta(\omega - m\omega_{0}) \right|^{2}. \\
		\frac{\dd  W_{\mathrm{rad}}}{\dd \Omega} &= \int_{0}^{\infty} \frac{\dd^{2} W_{\mathrm{rad}}}{\dd \Omega \dd \omega} \, \dd \omega = \frac{q^{2} \omega_{0}}{4\pi \varepsilon_{0} c} \tan^{2}\theta \sum_{m=1}^{\infty} m^{2} \left( J_{m}(m\beta_{0} \cos\theta) \right)^{2} = \frac{q^{2} \omega_{0} \beta_{0}^{2} \sin^{2}\theta}{64\pi \varepsilon_{0} c} \frac{4 + \beta_{0}^{2} \cos^{2}\theta}{(1 - \beta_{0}^{2} \cos^{2}\theta)^{7/2}}. \\
		W_{\mathrm{rad}} &= 2\pi \int_{0}^{\pi} \frac{\dd  W_{\mathrm{rad}}}{\dd \Omega} \sin\theta \, \dd \theta = \frac{q^{2} \omega_{0}^{3} a^{2}}{24 \varepsilon_{0} c^{3}} \frac{4 - 3\beta_{0}^{2}}{(1 - \beta_{0}^{2})^{3/2}}.
	\end{align*}
\end{exbox}
\begin{note}
	...
	\begin{align*}
		\frac{\dd  P_{\mathrm{rad}}}{\dd \Omega} = \frac{q^{2}}{16\pi^{2} \varepsilon_{0} c} \frac{| \uv{R} \times \left( (\uv{R} - \vb{\beta}) \times \dot{\vb{\beta}} \right) |^{2}}{(1 - \uv{R} \cdot \vb{\beta})^{5}}.
	\end{align*}
	...
	\begin{align*}
		...
		\frac{\dd  P_{\mathrm{rad}}}{\dd \Omega} &= \frac{q^{2} \beta^{4} c}{16\pi^{2} \varepsilon_{0} \rho^{2}} \frac{1 - \sin^{2}\varphi \cos^{2}\theta + \beta^{2} \cos^{2}\theta - 2\beta \cos\varphi \cos\theta}{(1 - \beta \cos\theta \cos\varphi)^{5}}. \\
		\frac{\dd  W_{\mathrm{rad}}}{\dd \Omega} &= \int_{0}^{2\pi} \frac{\dd  P_{\mathrm{rad}}}{\dd \Omega} \frac{\rho}{\beta c} \, \dd \varphi = \frac{q^{2} \beta^{3}}{64\pi \varepsilon_{0} \rho} \frac{4(1 + \sin^{2}\theta) - \beta^{2} \cos^{4}\theta (1 + 3\beta^{2})}{(1 - \beta^{2} \cos^{2}\theta)^{7/2}}.
	\end{align*}
	...
	\begin{align*}
		...
		\frac{\dd  P_{\mathrm{rad}}}{\dd \Omega} &= \frac{q^{2} \omega_{0}^{2} \beta_{0}^{2}}{16\pi^{2} \varepsilon_{0} c} \frac{\sin^{2}\theta \cos^{2}(\omega_{0} t_{s})}{(1 + \beta_{0} \sin(\omega_{0} t_{s}) \cos\theta)^{5}}. \\
		\frac{\dd  W_{\mathrm{rad}}}{\dd \Omega} &= \int_{0}^{2\pi/\omega_{0}} \frac{\dd  P_{\mathrm{rad}}}{\dd \Omega} \, \dd t_{s} = \frac{q^{2} \omega_{0} \beta_{0}^{2} \sin^{2}\theta}{64\pi \varepsilon_{0} c} \frac{4 + \beta_{0}^{2} \cos^{2}\theta}{(1 - \beta_{0}^{2} \cos^{2}\theta)^{7/2}}.
	\end{align*}

	结果与之前完全一致.

	两类运动辐射场空间分布如\cref{fig:periodic_radiation_angular},\cref{fig:circular_rad_field},\cref{fig:harmonic_rad_field}，轨道尺寸\(a/\lambda=1.2\)，画图截面为\(x/y/z=0\).简谐运动标注中的\(\beta\)指\(\beta_0\)，\(\eta\)指轨道相位（最大位移处\(\eta=0\)，平衡位置处\(\eta=0.25\)）.
\end{note}

\section{局域时变电荷体系的电磁场}
...
\begin{align*}
	&\int \vb{J}\left( \vb{r}', t - \frac{r}{c} \right) \dd \vb{r}' = \int \left( \nabla' \cdot (\vb{J} \vb{r}') - \vb{r}' \nabla' \cdot \vb{J}\left( \vb{r}', t - \frac{r}{c} \right) \right) \dd \vb{r}' = \int \frac{\partial \rho\left( \vb{r}', t - \frac{r}{c} \right)}{\partial t} \vb{r}' \dd \vb{r}'.\\
	&\int \left( \vb{r}' \vb{J}\left( \vb{r}', t - \frac{r}{c} \right) + \vb{J}\left( \vb{r}', t - \frac{r}{c} \right) \vb{r}' \right) \dd \vb{r}' = \int \left( \nabla' \cdot (\vb{J} \vb{r}' \vb{r}') - \vb{r}' \vb{r}' \nabla' \cdot \vb{J}\left( \vb{r}', t - \frac{r}{c} \right) \right) \dd \vb{r}' = \int \frac{\partial \rho\left( \vb{r}', t - \frac{r}{c} \right)}{\partial t} \vb{r}' \vb{r}' \dd \vb{r}'.
\end{align*}

进行规范变换 \(\vb{A} \to \vb{A} + \nabla \Lambda\)，\(\Phi \to \Phi - \partial\Lambda/\partial t\)，引入规范函数：
\begin{align*}
	\Lambda = \frac{1}{24\pi\varepsilon_0 c^2 r} \int (r')^2 \frac{\partial \rho}{\partial t} \dd \vb{r}'.
\end{align*}
...
\begin{align*}
	q = \int \rho\left( \vb{r}', t - \frac{r}{c} \right) \dd \vb{r}' = \text{const}, \quad
	\vb{p} = \int \rho\left( \vb{r}', t - \frac{r}{c} \right) \vb{r}' \dd \vb{r}'.
\end{align*}
\begin{align*}
	\vb{D} =\int \rho\left( \vb{r}', t - \frac{r}{c} \right) \left(3\vb{r}' \vb{r}' - r'^2 \vb{I}\right) \dd \vb{r}', \quad
	\vb{m} = \frac{1}{2} \int \vb{r}' \times \vb{J}\left( \vb{r}', t - \frac{r}{c} \right) \dd \vb{r}'.
\end{align*}
\(\vb{D}\) 按此定义是无迹张量，因而后面的四极辐射功率可直接使用 STF 角积分；若改用未去迹的二阶矩 \(\int\rho\,\vb{r}'\vb{r}'\,\dd\vb{r}'\)，功率公式中的系数和缩并形式都必须相应重写。
...
进而，能量辐射功率为：
\begin{align*}
	\frac{\dd P_{\text{rad}}}{\dd \Omega} & = \left. \frac{r^2}{\mu_0} \text{Re}\left[ \vb{E}_{\text{rad}} \times \vb{B}_{\text{rad}}^* \right] \cdot \uv{r} \right|_{r \to \infty}                                                                                                                                                                                 \\&= \frac{1}{16\pi^2\varepsilon_0 c^3} \left| \frac{\partial^2 \vb{p}}{\partial t^2} \times \uv{r} \right|^2 + \frac{1}{16\pi^2\varepsilon_0 c^5} \left| \frac{\partial^2 \vb{m}}{\partial t^2} \times \uv{r} \right|^2
...
四极项的系数来自无迹条件下的角积分
\begin{align*}
	\int \left|(\vb{Q}\cdot\uv{r})\times\uv{r}\right|^2 \dd\Omega
...
角动量辐射功率为
\begin{align*}
	&\frac{\dd^2 \vb{L}_{\text{rad}}}{\dd t \, \dd \Omega} = \left. r^2 \uv{r} \cdot \left( \vb{T}_{\text{em}} \times \vb{r} \right) \right|_{r \to \infty}
...
\begin{exbox}
	...
	\begin{align*}
		\mu \frac{\dd^2\vb{r}}{\dd t^2} = -\frac{\alpha}{r^3}\vb{r}, \quad \vb{L} = \mu \vb{r} \times \frac{\dd \vb{r}}{\dd t}, \quad \vb{p} = \Gamma \mu \vb{r}.
	\end{align*}

	进而
	\begin{align*}
		\frac{\dd \vb{p}}{\dd t} &= \Gamma \mu \frac{\dd \vb{r}}{\dd t}, \quad \frac{\dd^2\vb{p}}{\dd t^2} = -\frac{\Gamma \alpha}{r^3}\vb{r}, \quad
		\left( \frac{\dd \vb{p}}{\dd t} \right) \times \left( \frac{\dd^2\vb{p}}{\dd t^2} \right) = \frac{\Gamma^2 \alpha \vb{L}}{r^3}, \quad \left| \frac{\dd^2\vb{p}}{\dd t^2} \right|^2 = \frac{\Gamma^2 \alpha^2}{r^4}.
	\end{align*}

	运用开普勒运动的结论
	\begin{align*}
		r = \frac{p}{1 + e\cos\theta}, \quad \frac{\dd t}{\dd \theta} = \sqrt{\frac{\mu p^3}{\alpha}} \frac{1}{(1 + e\cos\theta)^2}, \quad L = \sqrt{\mu\alpha p}.
	\end{align*}

	进而运动过程中损失的能量、角动量为
	\begin{align*}
		E_{\text{loss}} &= \frac{1}{6\pi\varepsilon_0 c^3} \int \left| \frac{\dd^2\vb{p}}{\dd t^2} \right|^2 \dd t = \frac{\Gamma^2 \alpha^2}{6\pi\varepsilon_0 c^3} \int_{-\pi + \arccos(1/e)}^{\pi - \arccos(1/e)} \frac{1}{r^4} \frac{\dd t}{\dd \theta} \dd \theta \\
		...
		\vb{L}_{\text{loss}} &= \frac{1}{6\pi\varepsilon_0 c^3} \int\left( \frac{\dd \vb{p}}{\dd t} \right) \times \left( \frac{\dd^2\vb{p}}{\dd t^2} \right) \dd t= \frac{\Gamma^2 \alpha \vb{L}}{6\pi\varepsilon_0 c^3} \int_{-\pi + \arccos(1/e)}^{\pi - \arccos(1/e)} \frac{1}{r^3} \frac{\dd t}{\dd \theta} \dd \theta \\
...
\begin{exbox}
	...
	\begin{align*}
		-\frac{\dd E}{\dd t} &= \frac{\Gamma^2 \alpha^2}{6\pi\varepsilon_0 c^3 T} \int_{0}^{2\pi} \frac{1}{r^4} \frac{\dd t}{\dd \theta} \dd \theta = \frac{\Gamma^2 \alpha^2}{6\pi\varepsilon_0 c^3 p^4} \left(1 + \frac{e^2}{2}\right) (1 - e^2)^{3/2}, \\
		-\frac{\dd \vb{L}}{\dd t} &= \frac{\Gamma^2 \alpha \vb{L}}{6\pi\varepsilon_0 c^3 T} \int_{0}^{2\pi} \frac{1}{r^3} \frac{\dd t}{\dd \theta} \dd \theta = \frac{\Gamma^2 \alpha^{3/2} \mu^{1/2}}{6\pi\varepsilon_0 c^3 p^{5/2}} (1 - e^2)^{3/2} \uv{L}.
	\end{align*}
	其中
	\begin{align*}
		r = \frac{p}{1 + e\cos\theta}, \quad \frac{\dd t}{\dd \theta} = \sqrt{\frac{\mu p^3}{\alpha}} \frac{1}{(1 + e\cos\theta)^2}, \quad L = \sqrt{\mu\alpha p}, \quad T = \frac{2\pi}{(1 - e^2)^{3/2}} \sqrt{\frac{\mu p^3}{\alpha}}.
	\end{align*}

	可见两电荷将做准焦距、离心率不断减小的椭圆轨道运动.具体而言，由
	\begin{align*}
		L = \sqrt{\mu\alpha p}, \quad \frac{\dd L}{\dd t} = \frac{1}{2}\sqrt{\frac{\alpha\mu}{p}} \frac{\dd p}{\dd t}, \quad E = -\frac{\alpha(1 - e^2)}{2p}, \quad \frac{\dd E}{\dd t} = \frac{\alpha}{2p^2}\left[(1 - e^2)\frac{\dd p}{\dd t} + 2ep\frac{\dd e}{\dd t}\right]
	\end{align*}

	得
	\begin{align*}
		\frac{\dd e}{e \dd t} = \frac{3}{4}\frac{\dd p}{p \dd t} = -\frac{(1 - e^2)^{3/2} \alpha \Gamma^2}{4\pi\varepsilon_0 c^3 p^3}.
	\end{align*}
...
\begin{exbox}
	...
	\begin{align*}
		\mu \frac{\dd^2\vb{r}}{\dd t^2} &= -\frac{\alpha}{r^3}\vb{r}, \quad \vb{L} = \mu \vb{r} \times \frac{\dd \vb{r}}{\dd t}, \quad \vb{p} = \Gamma \mu \vb{r}, \quad
	...
	运用开普勒运动的结论
	\begin{align*}
		r = \frac{p}{e\cos\theta - 1}, \quad \frac{\dd t}{\dd \theta} = \sqrt{\frac{\mu p^3}{\alpha}} \frac{1}{(e\cos\theta - 1)^2}, \quad L = \sqrt{\mu\alpha p}.
	\end{align*}

	进而运动过程中损失的能量、角动量为
	\begin{align*}
		E_{\text{loss}} &= \frac{1}{6\pi\varepsilon_0 c^3} \int \left| \frac{\dd^2\vb{p}}{\dd t^2} \right|^2 \dd t = \frac{\Gamma^2 \alpha^2}{6\pi\varepsilon_0 c^3} \int_{-\arccos(1/e)}^{\arccos(1/e)} \frac{1}{r^4} \frac{\dd t}{\dd \theta} \dd \theta \\
		&= \frac{\Gamma^2 \alpha^{3/2} \mu^{1/2}}{6\pi\varepsilon_0 c^3 p^{5/2}} \left[ -3\sqrt{e^2 - 1} + (2 + e^2)\arccos\left(\frac{1}{e}\right) \right], \\
		\vb{L}_{\text{loss}} &= \frac{1}{6\pi\varepsilon_0 c^3} \int\left(\frac{\dd \vb{p}}{\dd t}\right) \times \left(\frac{\dd^2\vb{p}}{\dd t^2}\right) \dd t = \frac{\Gamma^2 \alpha \vb{L}}{6\pi\varepsilon_0 c^3} \int_{-\arccos(1/e)}^{\arccos(1/e)} \frac{1}{r^3} \frac{\dd t}{\dd \theta} \dd \theta \\
	...
	\begin{align*}
		\frac{\dd \vb{D}}{\dd t} &= \chi \mu \left( 3\frac{\dd \vb{r}}{\dd t}\vb{r} + 3\vb{r}\frac{\dd \vb{r}}{\dd t} - 2\left( \vb{r} \cdot \frac{\dd \vb{r}}{\dd t} \right)\vb{I} \right), \\
		\frac{\dd^2\vb{D}}{\dd t^2} &= 2\chi \alpha p \left( \frac{3\vb{r}\vb{r} - r^2 \vb{I}}{r^3 p} + \frac{\mu^2}{L^2} \left( 3\frac{\dd \vb{r}}{\dd t}\frac{\dd \vb{r}}{\dd t} - \left| \frac{\dd \vb{r}}{\dd t} \right|^2 \vb{I} \right) \right), \\
		\frac{\dd^3\vb{D}}{\dd t^3} &= -\frac{2\chi \alpha}{r^3} \left( 9\frac{\vb{r}\vb{r}}{r^2} \left( \vb{r} \cdot \frac{\dd \vb{r}}{\dd t} \right) - 6\left( \frac{\dd \vb{r}}{\dd t}\vb{r} + 3\vb{r}\frac{\dd \vb{r}}{\dd t} \right) + \left( \vb{r} \cdot \frac{\dd \vb{r}}{\dd t} \right)\vb{I} \right).\\
		\frac{\dd^3\vb{D}}{\dd t^3} : \frac{\dd^3\vb{D}}{\dd t^3} &= \frac{24\chi^2 \alpha^2}{r^6} \left( -11\left( \vb{r} \cdot \frac{\dd \vb{r}}{\dd t} \right)^2 + 12 r^2 \left| \frac{\dd \vb{r}}{\dd t} \right|^2 \right).\\
		\frac{\dd^2\vb{D}}{\dd t^2} \cdot \left( \frac{\dd^3\vb{D}}{\dd t^3} \right) &= \frac{36\chi^2 \alpha^2 p \vb{L}}{\mu r^5} \left( \frac{2r}{p} + \frac{3\mu^2}{L^2} \left( \vb{r} \cdot \frac{\dd \vb{r}}{\dd t} \right)^2 - \frac{2\mu^2}{L^2} r^2 \left| \frac{\dd \vb{r}}{\dd t} \right|^2 \right).
	\end{align*}

	运用开普勒运动的结论
	\begin{align*}
		r = \frac{p}{e\cos\theta - 1}, \quad \frac{\dd \vb{r}}{\dd t} = \frac{L}{\mu r} \left( \frac{e\sin\theta}{e\cos\theta - 1}\uv{r} + \uv{\theta} \right), \quad \frac{\dd t}{\dd \theta} = \sqrt{\frac{\mu p^3}{\alpha}} \frac{1}{(e\cos\theta - 1)^2}, \quad L = \sqrt{\mu\alpha p}.
	\end{align*}

	经过繁琐的积分得
	\begin{align*}
		E_{\text{loss}} &= \int_{-\arccos(1/e)}^{\arccos(1/e)} \frac{1}{720\pi\varepsilon_0 c^5} \left( \frac{\partial^3\vb{D}}{\partial t^3} : \frac{\partial^3\vb{D}}{\partial t^3} \right) \frac{\dd t}{\dd \theta} \dd \theta \\
		...
		\vb{L}_{\text{loss}} &= \int_{-\arccos(1/e)}^{\arccos(1/e)} \frac{1}{360\pi\varepsilon_0 c^5} \left( \frac{\partial^2\vb{D}}{\partial t^2} \cdot \left( \frac{\partial^3\vb{D}}{\partial t^3} \right) \right) \frac{\dd t}{\dd \theta} \dd \theta \\
...
\begin{note}
	...
	\begin{align*}
		\mu \frac{\dd^2\vb{r}}{\dd t^2} = -\frac{\alpha}{r^3}\vb{r}, \quad \vb{L} = \mu \vb{r} \times \frac{\dd \vb{r}}{\dd t}, \quad \vb{Q} = \mu \left( 3\vb{r}\vb{r} - r^2 \vb{I} \right).
	\end{align*}

	进而，质量四极矩的各阶变化率为
	\begin{align*}
		\frac{\dd \vb{Q}}{\dd t} &= \mu \left( 3\frac{\dd \vb{r}}{\dd t}\vb{r} + 3\vb{r}\frac{\dd \vb{r}}{\dd t} - 2\left( \vb{r} \cdot \frac{\dd \vb{r}}{\dd t} \right)\vb{I} \right), \\
		\frac{\dd^2\vb{Q}}{\dd t^2} &= 2\alpha p \left( -\frac{3\vb{r}\vb{r} - r^2 \vb{I}}{r^3 p} + \frac{\mu^2}{L^2} \left( 3\frac{\dd \vb{r}}{\dd t}\frac{\dd \vb{r}}{\dd t} - \left| \frac{\dd \vb{r}}{\dd t} \right|^2 \vb{I} \right) \right), \\
		\frac{\dd^3\vb{Q}}{\dd t^3} &= \frac{2\alpha}{r^3} \left( 9\frac{\vb{r}\vb{r}}{r^2} \left( \vb{r} \cdot \frac{\dd \vb{r}}{\dd t} \right) - 6\left( \frac{\dd \vb{r}}{\dd t}\vb{r} + 3\vb{r}\frac{\dd \vb{r}}{\dd t} \right) + \left( \vb{r} \cdot \frac{\dd \vb{r}}{\dd t} \right)\vb{I} \right).\\
		\frac{\dd^3\vb{Q}}{\dd t^3} : \frac{\dd^3\vb{Q}}{\dd t^3} &= \frac{24\alpha^2}{r^6} \left( -11\left( \vb{r} \cdot \frac{\dd \vb{r}}{\dd t} \right)^2 + 12 r^2 \left| \frac{\dd \vb{r}}{\dd t} \right|^2 \right).\\
		\frac{\dd^2\vb{Q}}{\dd t^2} \crossdot \left( \frac{\dd^3\vb{Q}}{\dd t^3} \right) &= \frac{36\alpha^2 p \vb{L}}{\mu r^5} \left( \frac{2r}{p} - \frac{3\mu^2}{L^2} \left( \vb{r} \cdot \frac{\dd \vb{r}}{\dd t} \right)^2 + \frac{2\mu^2}{L^2} r^2 \left| \frac{\dd \vb{r}}{\dd t} \right|^2 \right).
	\end{align*}

	由于观测时更关心周期性椭圆运动的平均效应，因此考虑周期平均后的辐射损失能量、角动量.运用开普勒运动的结论
	\begin{align*}
		r = \frac{p}{1 + e\cos\theta}, \quad \frac{\dd \vb{r}}{\dd t} = \frac{L}{\mu r} \left( \frac{e\sin\theta}{1 + e\cos\theta}\uv{r} + \uv{\theta} \right), \quad L = \sqrt{\mu\alpha p}, \quad T = \frac{2\pi}{(1 - e^2)^{3/2}} \sqrt{\frac{p^3}{\alpha\mu}}.
	\end{align*}

	并带入
	\begin{align*}
		\frac{\dd t}{\dd \theta} = \sqrt{\frac{\mu p^3}{\alpha}} \frac{1}{(1 + e\cos\theta)^2}.
	\end{align*}

	经过繁琐的积分得
	\begin{align*}
		-\frac{\dd E}{\dd t} &= \frac{G}{45 c^5 T} \int_{0}^{2\pi} \left( \frac{\dd^3\vb{Q}}{\dd t^3} : \frac{\dd^3\vb{Q}}{\dd t^3} \right) \frac{\dd t}{\dd \theta} \dd \theta
		= \frac{32 G}{5 c^5} \frac{\alpha^3}{\mu p^5} (1 - e^2)^{3/2} \left( 1 + \frac{73}{24}e^2 + \frac{37}{96}e^4 \right), \\
		-\frac{\dd \vb{L}}{\dd t} &= \frac{2 G}{45 c^5 T} \int_{0}^{2\pi} \left( \frac{\dd^2\vb{Q}}{\dd t^2} \crossdot \left( \frac{\dd^3\vb{Q}}{\dd t^3} \right) \right) \frac{\dd t}{\dd \theta} \dd \theta
		= \frac{32 G}{5 c^5} \frac{\alpha^{5/2} \uv{L}}{\mu^{1/2} p^{7/2}} (1 - e^2)^{3/2} \left( 1 + \frac{7}{8}e^2 \right).
	\end{align*}

	用两质点质量及轨道半长轴 \(a = p(1-e^2)^{-1}\) 表示，即为
	\begin{align*}
		-\frac{\dd E}{\dd t} &= \frac{32 G^4 M_1^2 M_2^2 (M_1 + M_2)}{5 c^5 a^5} (1 - e^2)^{-7/2} \left( 1 + \frac{73}{24}e^2 + \frac{37}{96}e^4 \right), \\
		-\frac{\dd \vb{L}}{\dd t} &= \frac{32 G^{7/2} M_1^2 M_2^2 (M_1 + M_2)^{1/2}}{5 c^5 a^{7/2}} (1 - e^2)^{-2} \left( 1 + \frac{7}{8}e^2 \right).
	\end{align*}
...
或写成
\begin{align*}
	\vb{D}(\vb{r},t) = \frac{\varepsilon_{0}}{\sqrt{2\pi}} \int_{-\infty}^{\infty} \varepsilon(t-\tau) \vb{E}(\vb{r},\tau) \, \dd \tau = \frac{\varepsilon_{0}}{\sqrt{2\pi}} \int_{-\infty}^{t} \varepsilon(t-\tau) \vb{E}(\vb{r},\tau) \, \dd \tau, \quad \varepsilon(t) = \frac{1}{\sqrt{2\pi}} \int \varepsilon(\omega) e^{-i\omega t} \, \dd \omega.
\end{align*}
...
再积分，便可得到频域上的电磁场
\begin{align*}
	\Phi(\vb{r},\omega) &= \frac{\mu_{0} c}{(2\pi)^{3/2}} \int \dd \vb{k} \, e^{i\vb{k}\cdot\vb{r}} \frac{c \vb{k} \cdot \vb{J}(\vb{k},\omega)}{\omega \varepsilon(\omega) (k^{2} - \omega^{2}/c^{2} \varepsilon(\omega))}, \\
	\vb{A}(\vb{r},\omega) &= \frac{\mu_{0}}{(2\pi)^{3/2}} \int \dd \vb{k} \, e^{i\vb{k}\cdot\vb{r}} \frac{\vb{J}(\vb{k},\omega)}{k^{2} - \omega^{2}/c^{2} \varepsilon(\omega)}.\\
	\vb{E}(\vb{r},\omega) &= \frac{i \mu_{0} \omega}{(2\pi)^{3/2}} \int \dd \vb{k} \, e^{i\vb{k}\cdot\vb{r}} \frac{1}{k^{2} - \omega^{2}/c^{2} \varepsilon(\omega)}\left( \vb{I} - \frac{\vb{k} \vb{k} c^{2}}{\varepsilon(\omega) \omega^{2}} \right) \cdot \vb{J}(\vb{k},\omega), \\
	\vb{B}(\vb{r},\omega) &= \frac{i \mu_{0}}{(2\pi)^{3/2}} \int \dd \vb{k} \, e^{i\vb{k}\cdot\vb{r}} \frac{\vb{k} \times \vb{J}(\vb{k},\omega)}{k^{2} - \omega^{2}/c^{2} \varepsilon(\omega)}.
\end{align*}
...
\begin{exbox}
	...
	\begin{align*}
		...
		\frac{\dd^{2} W_{\mathrm{rad}}}{\dd z \dd \omega} &= 2 \cdot 2\pi \rho \, \uv{\rho} \cdot \vb{S}(\vb{r},\omega) = \frac{\mu_{0} q^{2} \omega}{4\pi} \left( 1 - \frac{1}{\beta^{2} \varepsilon(\omega)} \right).
	\end{align*}
...
\begin{exbox}
	...
	\begin{align*}
		...
		\frac{\dd^{2} W_{\mathrm{rad}}}{\dd z \dd \omega} &= 2 \cdot \int_{0}^{2\pi} \dd \phi \, \rho \, \uv{\rho} \cdot \vb{S}(\vb{r}, \omega) = \frac{\mu_{0} \Lambda^{4}}{4\pi \omega} \left( | \vb{\mu}_{q} |^{2} - \frac{1}{2} | \vb{\mu}_{q} \times \uv{\beta} |^{2} \right) = \frac{\mu_{0} \omega^{3} (\beta^{2} \varepsilon(\omega) - 1)^{2}}{4\pi \beta^{4} c^{4}} \left( | \vb{\mu}_{q} |^{2} - \frac{1}{2} | \vb{\mu}_{q} \times \uv{\beta} |^{2} \right).
	\end{align*}
...
以该电流为源，在介质外远场产生辐射为
\begin{align*}
	\vb{E}_{\mathrm{ext}}(\vb{r}, \omega) &= \frac{i \omega \mu_{0} e^{i k r}}{4\pi r} \int \uv{k} \times \left( \vb{J}_{\mathrm{mag}}(\vb{r}', \omega) \times \uv{k} \right) e^{-i k \uv{r} \cdot \vb{r}'} \, \dd \vb{r}' \\
	&= \frac{\omega^{2} e^{i k r}}{4\pi r c^{2}} (\varepsilon(\omega) - 1) \int \uv{k} \times \left( \vb{E}(\vb{r}', \omega) \times \uv{k} \right) e^{-i \vb{k} \cdot \vb{r}'} \, \dd \vb{r}' \\
	&= \frac{i \omega \beta (\varepsilon(\omega) - 1) e^{i k r}}{4\pi r c (1 - n \beta \cos\theta)} \int \uv{k} \times \left( \vb{E}(\vb{r}', \omega) \times \uv{k} \right)\big|_{z=0} e^{-i \vb{k}_{\perp} \cdot \vb{r}_{\perp}'} \, \dd \vb{r}_{\perp}'.
\end{align*}
其中 \(\vb{k} = n \omega/c \;(\sin\theta, 0, \cos\theta)\)，\(n\)是介质外部空间的折射率，最后的积分关于垂直于运动方向的截面进行，而关于运动方向的积分用到
\begin{align*}
	\int_{0}^{\infty} e^{i \left( \frac{\omega}{\beta c} - k \cos\theta \right) z'} \, \dd z' = i \left( \frac{\omega}{\beta c} - k \cos\theta \right)^{-1}.
\end{align*}
...
\begin{equation*}
	\begin{split}
		\vb{E}_{\mathrm{ext}} = \frac{i \omega \beta (\varepsilon(\omega) - 1) e^{i k r}}{4\pi r c (1 - n \beta \cos\theta)} \int \left[ \uv{e}_{a} \left( \cos\theta (E_{\rho} \cos\phi - E_{\phi} \sin\phi) - \sin\theta E_{z} \right) + \uv{e}_{b} \left( E_{\rho} \sin\phi + E_{\phi} \cos\phi \right) \right]_{z=0} e^{-i k \rho \cos\phi \sin\theta} \, \rho \, \dd \rho \, \dd \phi.
	\end{split}
\end{equation*}
}
...
辐射功率频谱的立体角分布为
\begin{align*}
	\frac{\dd^{2} W_{\mathrm{ext}}}{\dd \Omega \dd \omega} = \sqrt{\frac{\varepsilon_{0}}{\mu_{0}}} \, 2 r^{2} | \vb{E}_{\mathrm{ext}}(\vb{r}, \omega) |^{2}.
\end{align*}
...
约化的辐射功率频谱的立体角分布即为
\begin{align*}
	\frac{\dd^{2} W_{\mathrm{ext}}}{\dd \nu \dd \eta} = \frac{\pi}{\gamma^{2}} \gamma \omega_{p} \frac{\dd^{2} W_{\mathrm{ext}}}{\dd \Omega \dd \omega} = \frac{\pi \omega_{p}}{\gamma} \sqrt{\frac{\varepsilon_{0}}{\mu_{0}}} \, 2 r^{2} | \vb{E}_{\mathrm{ext}}(\vb{r}, \omega) |^{2}.
\end{align*}
其中，由于 \(\gamma\) 很大，\(\eta\) 范围近似为 \(0\) 至 \(\infty\)，\(\nu\)的上限可估算取 \(\nu_{m} =m c^{2}/\hbar \omega_{p}\) (\(m\) 是粒子质量，该式对应最大辐射情形 \(\hbar\omega = \gamma m c^{2}\))，一般而言 \(\nu_{m} \gg 1\).

对于点电荷，不难化简为
\begin{align*}
	\vb{E}_{\mathrm{ext}}(\vb{r}, \omega)\big|_{q} &= -\uv{e}_{a} \frac{q e^{i k r}}{4\pi \varepsilon_{0} r c} \sqrt{\frac{2}{\pi}} \frac{\gamma \sqrt{\eta}}{(1 + \eta) (1 + \nu^{2} (1 + \eta))}.\\\frac{\dd^{2} W_{\mathrm{ext}}}{\dd \nu \dd \eta}\bigg|_{q} &= \frac{q^{2} \omega_{p} \gamma}{4\pi^{2} \varepsilon_{0} c} \frac{\eta}{(1 + \eta)^{2} (1 + \nu^{2} (1 + \eta))^{2}}.\\\frac{\dd  W_{\mathrm{ext}}}{\dd \nu}\bigg|_{q} &= \int_{0}^{\infty} \frac{\dd^{2} W_{\mathrm{ext}}}{\dd \nu \dd \eta}\bigg|_{q} \, \dd \eta = \frac{q^{2} \omega_{p} \gamma}{4\pi^{2} \varepsilon_{0} c} \left( (1 + 2\nu^{2}) \ln(1 + \nu^{-2}) - 2 \right).\\W_{\mathrm{ext}}\big|_{q} &= \int_{0}^{\infty} \frac{\dd  W_{\mathrm{ext}}}{\dd \nu}\bigg|_{q} \, \dd \nu = \frac{q^{2}}{4\pi \varepsilon_{0} \hbar c} \frac{\gamma}{3} \hbar \omega_{p}.
\end{align*}

角频率大于 \(\omega_{p}\) 的光子数量可估算为
\begin{align*}
	N_{\mathrm{ph}}\big|_{q} = \int_{1/\gamma}^{\infty} \frac{\dd  W_{\mathrm{ext}}}{\dd \nu}\bigg|_{q} \frac{1}{\hbar \omega} \, \dd \nu = \frac{q^{2}}{4\pi \varepsilon_{0} \hbar c} \frac{1}{\pi} \left( 1 - \frac{(1 + \gamma^{2}) \ln(1 + \gamma^{2})}{\gamma^{2}} - \frac{1}{2} \mathrm{Li}_{2}(-\gamma^{2}) \right) \overset{\gamma \gg 1}{\approx} \frac{q^{2}}{4\pi \varepsilon_{0} \hbar c} \frac{1}{\pi} \left( (\ln \gamma - 1)^{2} + \frac{\pi^{2}}{12} \right).
\end{align*}
...
\begin{align*}
	G(\nu_{m}) = \frac{(5\nu_{m}^{3} + 6\nu_{m}^{5}) \ln(1 + \nu_{m}^{-2}) - 6\nu_{m}^{3} - 2\nu_{m} + 2 \arctan\nu_{m}}{(3\nu_{m} + 2\nu_{m}^{3}) \ln(1 + \nu_{m}^{-2}) - 2\nu_{m} + 2 \arctan\nu_{m}}.
\end{align*}
\(G(\nu)\)如\cref{fig:g_plot}、分式线上下关于\(\nu\)的被积函数如\cref{fig:charge_magnet_radiation_spectrum}.
...
\begin{figure}[htbp]
	...
	\begin{minipage}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=\textwidth]{spectral_weight_function_g_nu_plot.png}
		\caption{\(G(\nu)\)图像}
		\label{fig:g_nu_plot}
		\label{fig:g_plot}
	\end{minipage}
	...
	\begin{minipage}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=\textwidth]{charge_and_magnetic_moment_radiation_energy_spectrum.png}
		\caption{电荷及磁矩辐射能量频谱}
		\label{fig:charge_magnet_radiation_spectrum}
	\end{minipage}
\end{figure}
\begin{figure}[htbp]
	\centering
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_radiation_angular_distribution.png}
		\caption{圆周运动}
		\label{fig:periodic_radiation_angular_circular}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_radiation_angular_distribution.png}
		\caption{简谐运动}
		\label{fig:periodic_radiation_angular_harmonic}
	\end{subfigure}
	\caption{点电荷周期运动辐射能量角分布}
	\label{fig:periodic_radiation_angular}
\end{figure}
\begin{figure}[htbp]
	\centering
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_e_xy_beta_0_6.png}
		\caption{\(E|_{xy}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_e_xy_b06}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_e_xy_beta_0_9.png}
		\caption{\(E|_{xy}\) (\(\beta=0.9\))}
		\label{fig:circular_rad_field_e_xy_b09}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_e_xz_beta_0_6.png}
		\caption{\(E|_{xz}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_e_xz_b06}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_e_yz_beta_0_6.png}
		\caption{\(E|_{yz}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_e_yz_b06}
	\end{subfigure}
	\vspace{0.2cm}
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_b_xy_beta_0_6.png}
		\caption{\(B|_{xy}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_b_xy_b06}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_b_xy_beta_0_9.png}
		\caption{\(B|_{xy}\) (\(\beta=0.9\))}
		\label{fig:circular_rad_field_b_xy_b09}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_b_xz_beta_0_6.png}
		\caption{\(B|_{xz}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_b_xz_b06}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_b_yz_beta_0_6.png}
		\caption{\(B|_{yz}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_b_yz_b06}
	\end{subfigure}
	\vspace{0.2cm}
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_e_farfield_xy_beta_0_6.png}
		\caption{\(E|_{xy}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_e_xy_b06_b}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_e_farfield_xy_beta_0_9.png}
		\caption{\(E|_{xy}\) (\(\beta=0.9\))}
		\label{fig:circular_rad_field_e_xy_b09_b}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_e_farfield_xz_beta_0_6.png}
		\caption{\(E|_{xz}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_e_xz_b06_b}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_e_farfield_yz_beta_0_6.png}
		\caption{\(E|_{yz}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_e_yz_b06_b}
	\end{subfigure}
	\vspace{0.2cm}
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_s_xy_beta_0_6.png}
		\caption{\(S|_{xy}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_s_xy_b06}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_s_xy_beta_0_9.png}
		\caption{\(S|_{xy}\) (\(\beta=0.9\))}
		\label{fig:circular_rad_field_s_xy_b09}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_s_xz_beta_0_6.png}
		\caption{\(S|_{xz}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_s_xz_b06}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_s_yz_beta_0_6.png}
		\caption{\(S|_{yz}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_s_yz_b06}
	\end{subfigure}
	\vspace{0.2cm}
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_tau_xy_beta_0_6.png}
		\caption{\(\tau|_{xy}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_tau_xy_b06}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_tau_xy_beta_0_9.png}
		\caption{\(\tau|_{xy}\) (\(\beta=0.9\))}
		\label{fig:circular_rad_field_tau_xy_b09}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_tau_xz_beta_0_6.png}
		\caption{\(\tau|_{xz}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_tau_xz_b06}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{circular_motion_tau_yz_beta_0_6.png}
		\caption{\(\tau|_{yz}\) (\(\beta=0.6\))}
		\label{fig:circular_rad_field_tau_yz_b06}
	\end{subfigure}

	\caption{点电荷圆周运动辐射场示意图}
	\label{fig:circular_rad_field}
\end{figure}
\begin{figure}[htbp]
	\centering
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_e_yz_beta_0_6_eta_0.png}
		\caption{\(E|_{yz}\) (\(\beta=0.6\), \(\eta=0\))}
		\label{fig:harmonic_rad_field_e_yz_b06_e0}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_e_yz_beta_0_6_eta_0_25.png}
		\caption{\(E|_{yz}\) (\(\beta=0.6\), \(\eta=0.25\))}
		\label{fig:harmonic_rad_field_e_yz_b06_e25}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_e_yz_beta_0_9_eta_0.png}
		\caption{\(E|_{yz}\) (\(\beta=0.9\), \(\eta=0\))}
		\label{fig:harmonic_rad_field_e_yz_b09_e0}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_e_yz_beta_0_9_eta_0_25.png}
		\caption{\(E|_{yz}\) (\(\beta=0.9\), \(\eta=0.25\))}
		\label{fig:harmonic_rad_field_e_yz_b09_e25}
	\end{subfigure}
	\vspace{0.2cm}
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_b_yz_beta_0_6_eta_0.png}
		\caption{\(B|_{yz}\) (\(\beta=0.6\), \(\eta=0\))}
		\label{fig:harmonic_rad_field_b_yz_b06_e0}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_b_yz_beta_0_6_eta_0_25.png}
		\caption{\(B|_{yz}\) (\(\beta=0.6\), \(\eta=0.25\))}
		\label{fig:harmonic_rad_field_b_yz_b06_e25}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_b_yz_beta_0_9_eta_0.png}
		\caption{\(B|_{yz}\) (\(\beta=0.9\), \(\eta=0\))}
		\label{fig:harmonic_rad_field_b_yz_b09_e0}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_b_yz_beta_0_9_eta_0_25.png}
		\caption{\(B|_{yz}\) (\(\beta=0.9\), \(\eta=0.25\))}
		\label{fig:harmonic_rad_field_b_yz_b09_e25}
	\end{subfigure}
	\vspace{0.2cm}
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_e_farfield_yz_beta_0_6_eta_0.png}
		\caption{\(E|_{yz}\) (\(\beta=0.6\), \(\eta=0\))}
		\label{fig:harmonic_rad_field_e_yz_b06_e0_b}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_e_farfield_yz_beta_0_6_eta_0_25.png}
		\caption{\(E|_{yz}\) (\(\beta=0.6\), \(\eta=0.25\))}
		\label{fig:harmonic_rad_field_e_yz_b06_e25_b}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_e_farfield_yz_beta_0_9_eta_0.png}
		\caption{\(E|_{yz}\) (\(\beta=0.9\), \(\eta=0\))}
		\label{fig:harmonic_rad_field_e_yz_b09_e0_b}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_e_farfield_yz_beta_0_9_eta_0_25.png}
		\caption{\(E|_{yz}\) (\(\beta=0.9\), \(\eta=0.25\))}
		\label{fig:harmonic_rad_field_e_yz_b09_e25_b}
	\end{subfigure}
	\vspace{0.2cm}
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_s_yz_beta_0_6_eta_0.png}
		\caption{\(S|_{yz}\) (\(\beta=0.6\), \(\eta=0\))}
		\label{fig:harmonic_rad_field_s_yz_b06_e0}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_s_yz_beta_0_6_eta_0_25.png}
		\caption{\(S|_{yz}\) (\(\beta=0.6\), \(\eta=0.25\))}
		\label{fig:harmonic_rad_field_s_yz_b06_e25}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_s_yz_beta_0_9_eta_0.png}
		\caption{\(S|_{yz}\) (\(\beta=0.9\), \(\eta=0\))}
		\label{fig:harmonic_rad_field_s_yz_b09_e0}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_s_yz_beta_0_9_eta_0_25.png}
		\caption{\(S|_{yz}\) (\(\beta=0.9\), \(\eta=0.25\))}
		\label{fig:harmonic_rad_field_s_yz_b09_e25}
	\end{subfigure}
	\vspace{0.2cm}
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_tau_yz_beta_0_6_eta_0.png}
		\caption{\(\tau|_{yz}\) (\(\beta=0.6\), \(\eta=0\))}
		\label{fig:harmonic_rad_field_tau_yz_b06_e0}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_tau_yz_beta_0_6_eta_0_25.png}
		\caption{\(\tau|_{yz}\) (\(\beta=0.6\), \(\eta=0.25\))}
		\label{fig:harmonic_rad_field_tau_yz_b06_e25}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_tau_yz_beta_0_9_eta_0.png}
		\caption{\(\tau|_{yz}\) (\(\beta=0.9\), \(\eta=0\))}
		\label{fig:harmonic_rad_field_tau_yz_b09_e0}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.23\textwidth}
		\includegraphics[width=\textwidth]{harmonic_motion_tau_yz_beta_0_9_eta_0_25.png}
		\caption{\(\tau|_{yz}\) (\(\beta=0.9\), \(\eta=0.25\))}
		\label{fig:harmonic_rad_field_tau_yz_b09_e25}
	\end{subfigure}

	\caption{点电荷简谐运动辐射场示意图}
	\label{fig:harmonic_rad_field}
\end{figure}
