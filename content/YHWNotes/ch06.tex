...
\begin{align*}
	\iint f_\alpha\left( \vb{r},\vb{v},t \right)\dd \vb{r}\dd \vb{v} = 1.
\end{align*}

在电磁场的作用下，从最原始的碰撞方程出发
\begin{align*}
	\frac{\dd f_\alpha}{\dd t} = \frac{\partial f_\alpha}{\partial t} + \vb{v}\cdot\frac{\partial f_\alpha}{\partial \vb{r}} + \frac{q_\alpha}{m_\alpha}\left( \vb{E} + \vb{v}\times\vb{B} \right)\cdot\frac{\partial f_\alpha}{\partial \vb{v}} = 0.
\end{align*}
...
\begin{align*}
	...
	&\frac{\dd \delta f_\alpha}{\dd t} = \frac{\partial \delta f_\alpha}{\partial t} + \vb{v}\cdot\frac{\partial \delta f_{\alpha0}}{\partial \vb{r}} = -\frac{q_\alpha}{m_\alpha}\left( \delta\vb{E} + \vb{v}\times\delta\vb{B} \right)\cdot\frac{\partial f_{\alpha0}}{\partial \vb{v}}.
\end{align*}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.35\textwidth]{cyclotron_motion_schematic_diagram.png}
	\caption{回旋运动示意图}
...
\end{align*}
如\cref{fig:gyromotion}，粒子做回旋运动，速度可写作
\begin{align*}
...
后一个方程给出
\begin{align*}
	\delta f_\alpha\left( \vb{r},\vb{v},t \right) = -\frac{q_\alpha}{m_\alpha}\int_{-\infty}^t \dd t'\left( \delta\vb{E}\left( \vb{r}',t' \right) + \vb{v}'(t')\times\delta\vb{B}\left( \vb{r}',t' \right) \right)\cdot\frac{\partial f_{\alpha0}\left( \vb{v}' \right)}{\partial \vb{v}'}.
\end{align*}
这里 \(\vb{v}'(t')\) 可以根据匀强磁场中的回旋运动求得，记 \(\tau = t-t'\)，则
\begin{align*}
	\frac{\dd^2 \vb{r}'}{\dd \tau^2} = -\frac{\dd \vb{v}'}{\dd \tau} = \Omega_\alpha \uv{z}\times\vb{v}',\quad
...
\begin{align*}
	&\mathcal{F}_\alpha\left( \vb{k},\vb{v},\omega \right) = \frac{1}{\left(2\pi\right)^2}\iint \delta f_\alpha\left( \vb{r},\vb{v},t \right)e^{-i\left( \vb{k}\cdot\vb{r}-\omega t \right)}\,\dd \vb{r}\,\dd t,\\
...
\begin{align*}
	...
	\int\frac{v_\perp}{2n_\alpha}\frac{\partial f_{\alpha0}}{\partial v_\perp}\dd \vb{v} + \sum_\alpha\frac{\omega_{p\alpha}^2}{\omega^2}\uv{b}\uv{b}\int\frac{v_{\parallel}}{n_\alpha}\frac{\partial f_{\alpha0}}{\partial v_{\parallel}}\dd \vb{v}\\
...
计算中用到
\begin{align*}
	\int\frac{v_\perp}{2n_\alpha}\frac{\partial f_{\alpha0}}{\partial v_\perp}\dd \vb{v} = \int\frac{v_{\parallel}}{n_\alpha}\frac{\partial f_{\alpha0}}{\partial v_{\parallel}}\dd \vb{v} = -1,
	\quad
...
\begin{align*}
	\mathrm{e}^{\kappa}\int_{0}^{\infty}t\mathrm{e}^{-t^2}J_n^2\left(t\sqrt{2\kappa}\right)\dd t = \frac{1}{2}I_n(\kappa).
\end{align*}
\begin{align*}
	Z(\zeta) = \frac{1}{\sqrt{\pi}}\int_{-\infty}^{\infty}\frac{\mathrm{e}^{-u^2}}{u-\zeta}\dd u, \quad Z'(\zeta) = -2\left(1+\zeta Z(\zeta)\right) = -\frac{2}{\sqrt{\pi}}\int_{-\infty}^{\infty}\frac{u\mathrm{e}^{-u^2}}{u-\zeta}\dd u.
\end{align*}
...
\begin{align*}
	\mathcal{F}_\alpha &= -\frac{q_\alpha}{m_\alpha}\int_{0}^{\infty}\left(\vb{\mathcal{E}}+\frac{\vb{v}^\prime\times\left(\vb{k}\times\vb{\mathcal{E}}\right)}{\omega}\right)\cdot\frac{\partial f_{\alpha0}}{\partial\vb{v}^\prime}\mathrm{e}^{i\left(\vb{k}\cdot\left(\vb{r}^\prime-\vb{r}\right)+\omega\tau\right)}\dd \tau\\
	&= -\frac{i}{\omega-\vb{k}\cdot\vb{v}}\frac{q_\alpha}{m_\alpha}\Bigg(\bigg(1-\frac{\vb{k}\cdot\vb{v}}{\omega}\bigg)\frac{\partial f_{\alpha0}}{\partial\vb{v}}+\bigg(\frac{\vb{k}}{\omega}\cdot\frac{\partial f_{\alpha0}}{\partial\vb{v}}\bigg)\vb{v}\Bigg)\cdot\vb{\mathcal{E}}.
\end{align*}
进而电流密度、电导率张量、介电常量张量可以求得
\begin{align*}
	&\vb{\mathcal{J}} = \sum_\alpha\int q_\alpha\vb{v}\mathcal{F}_\alpha\dd \vb{v} = \vb{\sigma}\cdot\vb{\mathcal{E}},\\
	&\vb{\varepsilon}_r = \vb{I} + \frac{i\vb{\sigma}}{\omega\varepsilon_0} = \vb{I} + \sum_\alpha\int\frac{\omega_{p\alpha}^2}{n_\alpha\omega^2}\bigg(\vb{v}\frac{\partial f_{\alpha0}}{\partial\vb{v}}+\bigg(\frac{\vb{k}}{\omega-\vb{k}\cdot\vb{v}}\cdot\frac{\partial f_{\alpha0}}{\partial\vb{v}}\bigg)\vb{v}\vb{v}\bigg)\dd \vb{v}.
\end{align*}
之后，再代入波动方程
\begin{align*}
	\vb{k}\times\left(\vb{k}\times\vb{\mathcal{E}}\right) + \frac{\omega^2}{c^2}\vb{\varepsilon}_r\cdot\vb{\mathcal{E}} = 0
\end{align*}
便可以解出色散关系和偏振模式.
...
\begin{exbox}
	...
	得到介电常量张量为
	\begin{align*}
		\vb{\varepsilon}_r &= \vb{I} + \sum_\alpha\int\frac{\omega_{p\alpha}^2}{n_\alpha\omega\left(\omega-\vb{k}\cdot\vb{v}\right)}\frac{\partial f_{\alpha0}}{v\,\partial v}\vb{v}\vb{v}\dd \vb{v}\\
		&= \vb{I} - \sum_\alpha\int\frac{\omega_{p\alpha}^2f_{\alpha0}}{n_\alpha\omega\left(\omega-\vb{k}\cdot\vb{v}\right)}\dd \vb{v}\left(\vb{I}-\uv{k}\uv{k}\right) + \sum_\alpha\int\frac{\omega_{p\alpha}^2\vb{k}\cdot\vb{v}}{n_\alpha k^2\left(\omega-\vb{k}\cdot\vb{v}\right)}\frac{\partial f_{\alpha0}}{v\,\partial v}\dd \vb{v}\,\uv{k}\uv{k}.
	\end{align*}
	可见，其形式与光轴为 \(\uv{k}\) 的单轴晶体相同，相应光学特征便也完全一致.

	代入波动方程，给出色散关系
	\begin{align*}
		1 - \frac{k^2c^2}{\omega^2} - \sum_\alpha\int\frac{\omega_{p\alpha}^2}{n_\alpha\omega\left(\omega-\vb{k}\cdot\vb{v}\right)}f_{\alpha0}\dd \vb{v} = 0.
	\end{align*}
	或
	\begin{align*}
		1 + \sum_\alpha\int\frac{\omega_{p\alpha}^2\vb{k}\cdot\vb{v}}{n_\alpha k^2\left(\omega-\vb{k}\cdot\vb{v}\right)}\frac{1}{v}\frac{\partial f_{\alpha0}}{\partial v}\dd \vb{v} = 0.
	\end{align*}
	后者要求电场是纵波 \(\left(\vb{\mathcal{E}}//\uv{k}\right)\)，也是大多数教材中考虑的等离子体色散方程.
	...
	介电常量张量可化简为
	\begin{align*}
		\vb{\varepsilon}_r = \Bigg(1 + \sum_\alpha\frac{\omega_{p\alpha}^2}{\omega^2}\bigg(-1 + \int\frac{k v_\perp^2}{\omega-k v_{\parallel}}\frac{1}{2n_\alpha}\frac{\partial f_{\alpha0}}{\partial v_{\parallel}}\dd \vb{v}\bigg)\Bigg)\left(\vb{I}-\uv{k}\uv{k}\right) + \Bigg(1 + \sum_\alpha\frac{\omega_{p\alpha}^2}{k}\int\frac{1}{\omega-k v_{\parallel}}\frac{1}{n_\alpha}\frac{\partial f_{\alpha0}}{\partial v_{\parallel}}\dd \vb{v}\Bigg)\uv{k}\uv{k}.
	\end{align*}
	形式仍然与光轴为 \(\uv{k}\) 的单轴晶体相同.

	代入波动方程，给出色散关系
	\begin{align*}
		1 - \frac{k^2c^2}{\omega^2} + \sum_\alpha\frac{\omega_{p\alpha}^2}{\omega^2}\bigg(-1 + \int\frac{k v_\perp^2}{\omega-k v_{\parallel}}\frac{1}{2n_\alpha}\frac{\partial f_{\alpha0}}{\partial v_{\parallel}}\dd \vb{v}\bigg) = 0.
	\end{align*}
	或
	\begin{align*}
		1 + \sum_\alpha\frac{\omega_{p\alpha}^2}{k}\int\frac{1}{\omega-k v_{\parallel}}\frac{1}{n_\alpha}\frac{\partial f_{\alpha0}}{\partial v_{\parallel}}\dd \vb{v} = 0
	\end{align*}
\end{exbox}

\begin{exbox}
	\label{eq:plasma_separable_xy}

	若速度分布关于横、纵向可分离变量，记
	\begin{align*}
		F_{\alpha0}(v_{\parallel}) = \int f_{\alpha0}(v_\perp,v_{\parallel})2\pi v_\perp\dd v_\perp.
	\end{align*}
	则
	\begin{align*}
		\vb{\varepsilon}_r = \vb{I} - \sum_\alpha\frac{\omega_{p\alpha}^2}{\omega^2}\left(\vb{I}-\uv{k}\uv{k}\right) + \sum_\alpha\frac{\omega_{p\alpha}^2}{k}\bigg(\frac{k^2v_{\mathrm{th}\perp\alpha}^2}{2\omega^2}\left(\vb{I}-\uv{k}\uv{k}\right)+\uv{k}\uv{k}\bigg)\int\frac{1}{\omega-k v_{\parallel}}\frac{1}{n_\alpha}\frac{\dd F_{\alpha0}}{\dd v_{\parallel}}\dd v_{\parallel}.
	\end{align*}
	...
	根据积分关系
	\begin{align*}
		\int\frac{1}{\omega-k v_{\parallel}}\frac{1}{2n_\alpha}\frac{\dd F_{\alpha0}}{\dd v_{\parallel}}\dd \vb{v} = \frac{2\left(1+\zeta_\alpha Z(\zeta_\alpha)\right)}{k^2v_{\mathrm{th}//\alpha}^2},\qquad \zeta_\alpha = \frac{\omega}{k v_{\mathrm{th}//\alpha}}.
	\end{align*}
	得到
	\begin{align*}
	...
	\begin{align*}
		1 - \frac{k^2c^2}{\omega^2} + \sum_\alpha\frac{\omega_{p\alpha}^2}{\omega^2}\bigg(-1 + \mathcal{P}\int\frac{k v_{\mathrm{th}\perp\alpha}^2}{\omega-k v_{\parallel}}\frac{1}{2n_\alpha}\frac{\dd F_{\alpha0}}{\dd v_{\parallel}}\dd v_{\parallel} + \frac{i\pi v_{\mathrm{th}\perp\alpha}^2}{2n_\alpha}F_{\alpha0}^\prime\left(\frac{\omega}{k}\right)\bigg) = 0.
	\end{align*}
	或
	\begin{align*}
		1 + \sum_\alpha\frac{\omega_{p\alpha}^2}{k}\bigg(\mathcal{P}\int\frac{1}{\omega-k v_{\parallel}}\frac{1}{n_\alpha}\frac{\dd F_{\alpha0}}{\dd v_{\parallel}}\dd v_{\parallel} + \frac{i\pi}{k n_\alpha}F_{\alpha0}^\prime\left(\frac{\omega}{k}\right)\bigg) = 0.
	\end{align*}
	可见，频率的解必然是复数，即存在阻尼.
\end{exbox}

\begin{exbox}
	例 \cref{eq:plasma_separable_xy} 的进一步讨论.

	基于例 \cref{eq:plasma_separable_xy} 给出的后一个色散方程，假设等离子体由电子和离子
	\begin{align*}
