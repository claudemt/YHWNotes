\chapter{\texorpdfstring{Lie 群、根系与 $SU(3)$}{Lie 群、根系与 SU(3)}}
...
\begin{definitionplain}[矩阵 Lie 群]
...
\section{\texorpdfstring{$SU(2)$ 与 $SO(3)$}{SU(2) 与 SO(3)}}
