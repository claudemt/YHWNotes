...
\begin{definitionplain}[限制表示与诱导表示]
...
\end{theorem}
\par\medskip
\noindent\textbf{Frobenius 互反律}\quad
...
\begin{exampleplain}[$SO(3)$ 的 Peter--Weyl 展开]
...
\end{proposition}
\par\medskip
\noindent\textbf{Plancherel 公式}\quad
