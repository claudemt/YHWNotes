...
\begin{definitionplain}[共轭类、中心与中心化子]
元素 $x\in G$ 的共轭类为
\[
...
\begin{exampleplain}[$D_3$ 的正规子群与商群：旋转子群为何特殊]
...
\begin{definitionplain}[自同构与内自同构]
