...
\begin{definitionplain}[对称操作、对称元素与点群]
...
\begin{definitionplain}[三维正交群与特殊正交群]
三维实正交群定义为
\[
...
\begin{exampleplain}[绕 $\lbrack 111\rbrack$ 轴转 $2\pi/3$]
立方体的一条三重轴沿
\[
...
\begin{definitionplain}[常见轴向 Schoenflies 点群]
以下记号按其生成对称元素定义：
\begin{align*}
C_n &: \text{仅含一条 $n$ 重主轴};\\
