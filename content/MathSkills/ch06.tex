...
Fredholm 指标在量子场论中描述 topological sector：Dirac 算子 $D$ 在规范场 $A$ 下的指标
\[
...
物理上，紧扰动 $H=H_0+V$ 的预解式在复平面亚纯，极点即束缚态（实轴）与共振态（下半平面）；统计力学中 transfer matrix 的极点给出配分函数的相变零点（Yang--Lee），光学中共振腔模态的 $Q$ 因子由极点虚部决定。
\end{derivation}
