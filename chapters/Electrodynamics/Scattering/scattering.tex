...
\begin{equation*}
	...
	&\frac{\d P_{sc}}{\d \Omega} = \frac{Z_0}{2k_0^2}\left| \sum_{l,m}\left( -a_{lm}\uv{r}\times\vb{X}_{lm} + b_{lm}\vb{X}_{lm} \right) \right|^2,\quad P_{sc} = \frac{Z_0}{2k_0^2}\sum_{l,m}\left( |a_{lm}|^2 + |b_{lm}|^2 \right).\\
