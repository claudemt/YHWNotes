...
下具体求出 \(\vb{P}, \vb{M}\) 和局域电荷分布的关系.假设电荷在 \(\vb{r}_s\) 点附近分布，该点以速度 \(\vb{v}_s = d\vb{r}_s/dt\) 运动，各电荷相对 \(\vb{r}_s\) 的位矢为 \(\vb{r}'\)，相对其的运动速度为 \(\vb{v}' = \d \vb{r}'/dt\).
宏观上，所有电荷都近似集中在 \(\vb{r}_s\)，空间电流也由 \(\vb{r}_s\) 的变化引起；微观上，则要考虑电荷关于 \(\vb{r}_s\) 的分布，即：
\begin{equation*}
	\nabla \cdot \vb{E} &= \frac{1}{\varepsilon_0} \int \rho\!\left( \vb{r}' + \vb{r}_s, t \right) \delta\!\left( \vb{r} - \vb{r}' - \vb{r}_s \right) \d \vb{r}', \\
	\nabla \cdot \vb{D} &= \int \rho\!\left( \vb{r}' + \vb{r}_s, t \right) \delta\!\left( \vb{r} - \vb{r}_s \right) \d \vb{r}', \\
	\nabla \times \vb{B} &= \frac{1}{c^2} \frac{\partial \vb{E}}{\partial t} + \mu_0 \int \rho\!\left( \vb{r}' + \vb{r}_s, t \right) \left( \vb{v}_s + \vb{v}' \right) \delta\!\left( \vb{r} - \vb{r}' - \vb{r}_s \right) \d \vb{r}', \\
	\nabla \times \vb{H} &= \frac{\partial \vb{D}}{\partial t} + \int \rho\!\left( \vb{r}' + \vb{r}_s, t \right) \vb{v}_s \delta\!\left( \vb{r} - \vb{r}_s \right) \d \vb{r}'.
\end{equation*}
其中 \(\d \vb{r}'\) 是源的体积元.
...
\begin{equation*}
	...
	\vb{r}'^{\otimes n} \cdot \nabla^{\otimes n}
	\delta\!\left( \vb{r} - \vb{r}_s \right) \d \vb{r}' \\
	&\to \vb{P}
	= \sum_{n=1}^{\infty} \frac{(-1)^{n-1}}{n!}
	\int \rho\!\left( \vb{r}' + \vb{r}_s, t \right)
	\vb{r}'^{\otimes n} \cdot \nabla^{\otimes (n-1)}
...
\begin{equation*}
	P^{(n)}(t) &= \int \rho\left( \vb{r}' + \vb{r}_s, t \right) \vb{r}'^{\otimes n} \d \vb{r}', \quad
	M^{(n)}(t) = \frac{n}{n+1} \int \vb{r}'^{\otimes (n-1)} \left( \vb{r}' \times \vb{J}\left( \vb{r}' + \vb{r}_s, t \right) \right) \d \vb{r}'.
\end{equation*}
...
在三维无界空间中，上式的解为：
\begin{equation*}
	\vb{\Pi}_e(\vb{r}, t) &= \frac{1}{4\pi} \int \frac{\vb{P}\left( \vb{r}', t - \dfrac{|\vb{r} - \vb{r}'|}{c} \right)}{|\vb{r} - \vb{r}'|} \d \vb{r}' = \frac{1}{4\pi} \sum_{n=1}^{\infty} \frac{(-1)^{n-1}}{n!} \nabla^{\otimes (n-1)} \cdot \frac{P^{(n)}(t-r/c)}{r}, \\
	\vb{\Pi}_m(\vb{r}, t) &= \frac{1}{4\pi} \int \frac{\vb{M}\left( \vb{r}', t - \dfrac{|\vb{r} - \vb{r}'|}{c} \right)}{|\vb{r} - \vb{r}'|} \d \vb{r}' = \frac{1}{4\pi} \sum_{n=1}^{\infty} \frac{(-1)^{n-1}}{n!} \nabla^{\otimes (n-1)} \cdot \frac{M^{(n)}(t-r/c)}{r}.
\end{equation*}
...
\subsection{对称无迹化的具体步骤}
根据上面关于电或磁极化的讨论，记：
\begin{equation*}
	P^{(n)} &= \int \rho \vb{r}'^{\otimes n} \d \vb{r}', \quad
	M^{(n)} = \frac{n}{n+1} \int \vb{r}'^{\otimes (n-1)} \left( \vb{r}' \times \vb{J} \right) \d \vb{r}'.
\end{equation*}
另外定义：
\begin{equation*}
	M^{(n.m)} &= \frac{n}{n+1} \int (r')^{2m} \vb{r}'^{\otimes (n-2m-1)} \left( \vb{r}' \times \vb{J} \right) \d \vb{r}', \\
	N^{(n)} &= \frac{n+1}{n+2} \int \vb{r}'^{\otimes (n-1)} \left( \vb{r}' \times \left( \vb{r}' \times \vb{J} \right) \right) \d \vb{r}', \quad
	N^{(n.m)} = \frac{n+1}{n+2} \int (r')^{2m} \vb{r}'^{\otimes (n-2m-1)} \left( \vb{r}' \times \left( \vb{r}' \times \vb{J} \right) \right) \d \vb{r}'.
\end{equation*}
...
\begin{equation*}
	\vb{\Pi}_e &\stackrel{\text{GT}}{=} \frac{1}{4\pi} \sum_{n=1}^{\infty} \frac{(-1)^{n-1}}{n!} \nabla^{\otimes (n-1)} \cdot \frac{\bm{\mathcal{P}}^{(n)}}{r}, \quad \vb{\Pi}_m \stackrel{\text{GT}}{=} \frac{1}{4\pi} \sum_{n=1}^{\infty} \frac{(-1)^{n-1}}{n!} \nabla^{\otimes (n-1)} \cdot \frac{\bm{\mathcal{M}}^{(n)}}{r}.\\
	\bm{\mathcal{P}}^{(n)} &= \sum_{m=0}^{\infty} \Delta^m \left( \frac{n}{2^m (n+2m)} \mathcal{STF}\Lambda^{\otimes m}[P^{(n+2m)}] - \sum_{k=0}^m \frac{n (n+2k)!}{2^k (n+2m+1) (n+2m+1)!} \mathcal{STF}\Lambda^{\otimes k}\left[ \mathcal{S} \frac{\partial N^{(n+2m.m-k)}}{c^2 \partial t} \right] \right), \\
...
\begin{equation*}
	...
	&= \frac{1}{4\pi \varepsilon_0} \sum_{n=1}^{\infty} \frac{(-1)^{n-1}}{n!} \nabla \times \left( \nabla \times \left( \nabla^{\otimes (n-1)} \cdot \frac{\bm{\mathcal{P}}^{(n)}}{r} \right) \right) - \frac{\mu_0}{4\pi} \sum_{n=1}^{\infty} \frac{(-1)^{n-1}}{n!} \nabla \times \left( \nabla^{\otimes (n-1)} \cdot \frac{\partial \bm{\mathcal{M}}^{(n)}}{r \partial t} \right), \\
	\vb{B} &= \mu_0 \left( \nabla \times \frac{\partial \vb{\Pi}_e}{\partial t} + \nabla \times (\nabla \times \vb{\Pi}_m) \right) \\
	&= \frac{\mu_0}{4\pi} \sum_{n=1}^{\infty} \frac{(-1)^{n-1}}{n!} \nabla \times \left( \nabla^{\otimes (n-1)} \cdot \frac{\partial \bm{\mathcal{P}}^{(n)}}{r \partial t} \right) + \frac{\mu_0}{4\pi} \sum_{n=1}^{\infty} \frac{(-1)^{n-1}}{n!} \nabla \times \left( \nabla \times \left( \nabla^{\otimes (n-1)} \cdot \frac{\bm{\mathcal{M}}^{(n)}}{r} \right) \right).
\end{equation*}

\subsection{特殊情况的讨论}
\subsubsection{前几项STF多极矩}
前几项可以展开为
\begin{equation*}
	&\bm{\mathcal{P}}^{(n)} = \mathcal{STF}P^{(n)} + \frac{\partial}{c^2 \partial t} \left( \frac{n}{2(n+2)} \mathcal{STF}\Lambda\left[ \frac{\partial P^{(n+2)}}{\partial t} \right] - \frac{n}{(n+1)^2} \mathcal{STF}N^{(n)} \right)\\+ &\,\,\frac{\partial^3}{c^4 \partial t^3} \left( \frac{n}{4(n+4)} \mathcal{STF}\Lambda^{\otimes 2}\left[ \frac{\partial P^{(n+4)}}{\partial t} \right] - \frac{n}{2(n+1)(n+2)(n+3)^2} \mathcal{STF}N^{(n+2.1)} - \frac{n}{2(n+3)^2} \mathcal{STF}\Lambda[\mathcal{S}N^{(n+2)}] \right) + \dots, \\
	&\bm{\mathcal{M}}^{(n)} = \mathcal{STF}M^{(n)} + \frac{\partial}{c^2 \partial t^2} \left( \frac{n}{2(n+2)} \mathcal{STF}\Lambda[\mathcal{S}M^{(n+2)}] + \frac{n}{(n+2)^2(n+1)} \mathcal{STF}M^{(n+2.1)} \right) + \dots.
\end{equation*}

这其中，首阶项 \(\mathcal{S}\mathcal{T}\mathcal{F}\, P^{(n)}\) 及 \(\mathcal{S}\mathcal{T}\mathcal{F}\, M^{(n)}\) 可以写成更紧凑的形式：
\begin{equation*}
	\mathcal{S}\mathcal{T}\mathcal{F}\, P^{(n)} &= \mathcal{S}\mathcal{T}\mathcal{F} \int \rho \, \vb{r}'^{\otimes n} \, \d \vb{r}' = \frac{(-1)^n}{(2n-1)!!} \int \rho \, (r')^{2n+1} \, \nabla'^{\otimes n} \frac{1}{r'} \, \d \vb{r}', \\
	\mathcal{S}\mathcal{T}\mathcal{F}\, M^{(n)} &= \frac{n}{n+1}\mathcal{S}\mathcal{T}\mathcal{F} \int \vb{r}'^{\otimes (n-1)} \left( \vb{r}' \times \vb{J} \right) \d \vb{r}' = \frac{(-1)^{n+1}}{(n+1)(2n-1)!!} \int (r')^{2n+1} \, (\vb{J} \times \nabla')_{(i_1} \nabla'_{i_2} \cdots \nabla'_{i_n)} \frac{1}{r'} \, \d \vb{r}'.
\end{equation*}

由电荷守恒 \(\partial \rho/\partial t + \nabla' \cdot \vb{J} = 0\)，并运用高斯定理，知：
\begin{equation*}
	\frac{\partial P^{(n)}}{\partial t} = \int r'_{i_1} \dots r'_{i_{n-1}} J_{i_n} \d \vb{r}'.
\end{equation*}

可见 \(\partial P^{(n)}/\partial t,\,M^{(n-1)},\,N^{(n-2)}\) 均具有 \(\int (r')^{n-1} J \, \d \vb{r}'\) 的量纲，是展开过程中的同阶项.若按照如上的方法，展开到\(n=5\)，可以得到：
\begin{equation*}
	\bm{\mathcal{P}}^{(1)} &= \int \vb{r}' \rho \, \d \vb{r}' - \frac{\partial}{c^2 \partial t} \cdot \frac{1}{10} \int \left( (\vb{r}' \cdot \vb{J}) \vb{r}' - 2 (r')^2 \vb{J} \right) \d \vb{r}' + \frac{\partial^3}{c^4 \partial t^3} \cdot \frac{1}{1680} \int \left( 11 (r')^4 \vb{J} - 5 (\vb{r}' \cdot \vb{J}) (r')^2 \vb{r}' \right) \d \vb{r}', \\
	\bm{\mathcal{P}}^{(2)} &= \int \left( \vb{r}' \vb{r}' - \frac{1}{3} (r')^2 \vb{I} \right) \rho \, \d \vb{r}' - \frac{\partial}{c^2 \partial t} \cdot \frac{1}{42} \int \left( 4 \vb{r}' \vb{r}' (\vb{r}' \cdot \vb{J}) - 5 (r')^2 (\vb{r}' \vb{J} + \vb{J} \vb{r}') + 2 (r')^2 (\vb{r}' \cdot \vb{J}) \vb{I} \right) \d \vb{r}', \\
	\bm{\mathcal{P}}^{(3)} &= \int \left( \vb{r}' \vb{r}' \vb{r}' - \frac{1}{5} (r')^2 \delta_{(i_1 i_2} r'_{i_3)} \right) \rho \, \d \vb{r}' - \frac{\partial}{c^2 \partial t} \cdot \frac{1}{60} \int \Bigg[ 5 \vb{r}' \vb{r}' \vb{r}' (\vb{r}' \cdot \vb{J}) - 5 (r')^2 r'_{(i_1} r'_{i_2} J_{i_3)} +\\&\qquad (r')^2 (\vb{r}' \cdot \vb{J}) \delta_{(i_1 i_2} r'_{i_3)} + (r')^4 \delta_{(i_1 i_2} J_{i_3)} \Bigg] \d \vb{r}', \\
	\bm{\mathcal{P}}^{(4)} &= \int \left( \vb{r}' \vb{r}' \vb{r}' \vb{r}' - \frac{1}{7} (r')^2 \delta_{(i_1 i_2} r'_{i_3} r'_{i_4)} + \frac{1}{35} (r')^4 \delta_{(i_1 i_2} \delta_{i_3 i_4)} \right) \rho \, \d \vb{r}', \\
	\bm{\mathcal{P}}^{(5)} &= \int \left( \vb{r}'^{\otimes 5} - \frac{1}{9} (r')^2 \delta_{(i_1 i_2} r'_{i_3} r'_{i_4} r'_{i_5)} + \frac{1}{63} (r')^4 \delta_{(i_1 i_2} \delta_{i_3 i_4} r'_{i_5)} \right) \rho \, \d \vb{r}'\\
	\bm{\mathcal{M}}^{(1)} &= \frac{1}{2} \int \vb{r}' \times \vb{J} \, \d \vb{r}' + \frac{1}{20}\frac{\partial}{c^2 \partial t^2}  \int (r')^2 (\vb{r}' \times \vb{J}) \, \d \vb{r}', \\
	\bm{\mathcal{M}}^{(2)} &= \frac{1}{3} \int \left( \vb{r}' (\vb{r}' \times \vb{J}) + (\vb{r}' \times \vb{J}) \vb{r}' \right) \d \vb{r}' + \frac{1}{42}\frac{\partial}{c^2 \partial t^2}  \int (r')^2 \left( \vb{r}' (\vb{r}' \times \vb{J}) + (\vb{r}' \times \vb{J}) \vb{r}' \right) \d \vb{r}', \\
	\bm{\mathcal{M}}^{(3)} &= \frac{1}{4} \int \left( \vb{r}' \vb{r}' (\vb{r}' \times \vb{J}) + \vb{r}' (\vb{r}' \times \vb{J}) \vb{r}' + (\vb{r}' \times \vb{J}) \vb{r}' \vb{r}' - \frac{1}{5} (r')^2 \delta_{(i_1 i_2} (\vb{r}' \times \vb{J})_{i_3)} \right) \d \vb{r}', \\
	\bm{\mathcal{M}}^{(4)} &= \frac{1}{5} \int \left( r'_{(i_1} r'_{i_2} r'_{i_3} (\vb{r}' \times \vb{J})_{i_4)} - \frac{1}{7} \delta_{(i_1 i_2} r'_{i_3} (\vb{r}' \times \vb{J})_{i_4)} \right) \d \vb{r}'.
\end{equation*}

\subsubsection{STF多极矩的电磁场}

将电磁场保留至与辐射能量和角动量辐射有关的部分，得：
\begin{equation*}
	\vb{E}_{\text{rad}} &= \frac{1}{4\pi \varepsilon_0 r} \sum_{n=1}^{\infty} \frac{1}{n!} \left[ \left( \left( \uv{r}^{\otimes (n-1)} \cdot \frac{\partial^{n+1} \bm{\mathcal{P}}^{(n)}}{c^{n+1} \partial t^{n+1}} \right) \times \uv{r} \right) \times \uv{r} - \frac{1}{c} \left( \uv{r}^{\otimes (n-1)} \cdot \frac{\partial^{n+1} \bm{\mathcal{M}}^{(n)}}{c^{n+1} \partial t^{n+1}} \right) \times \uv{r} \right] \\
	&\quad + \frac{1}{4\pi \varepsilon_0 r^2} \sum_{n=1}^{\infty} \frac{1}{n!} \cdot \frac{n+1}{2} \left( (n+2) \uv{r} \left( \uv{r}^{\otimes n} \cdot \frac{\partial^n \bm{\mathcal{P}}^{(n)}}{c^n \partial t^n} \right) - n \left( \uv{r}^{\otimes (n-1)} \cdot \frac{\partial^n \bm{\mathcal{P}}^{(n)}}{c^n \partial t^n} \right) \right), \\
	\vb{B}_{\text{rad}} &= \frac{\mu_0}{4\pi r} \sum_{n=1}^{\infty} \frac{1}{n!} \left[ \left( \left( \uv{r}^{\otimes (n-1)} \cdot \frac{\partial^{n+1} \bm{\mathcal{M}}^{(n)}}{c^{n+1} \partial t^{n+1}} \right) \times \uv{r} \right) \times \uv{r} + c \left( \uv{r}^{\otimes (n-1)} \cdot \frac{\partial^{n+1} \bm{\mathcal{P}}^{(n)}}{c^{n+1} \partial t^{n+1}} \right) \times \uv{r} \right] \\
	&\quad + \frac{\mu_0}{4\pi r^2} \sum_{n=1}^{\infty} \frac{1}{n!} \cdot \frac{n+1}{2} \left( (n+2) \uv{r} \left( \uv{r}^{\otimes n} \cdot \frac{\partial^n \bm{\mathcal{M}}^{(n)}}{c^n \partial t^n} \right) - n \left( \uv{r}^{\otimes (n-1)} \cdot \frac{\partial^n \bm{\mathcal{M}}^{(n)}}{c^n \partial t^n} \right) \right).
\end{equation*}

瞬时能量辐射功率为：
\small
\begin{equation*}
	\frac{\d  P_{\text{rad}}}{\d \Omega} &= \left. \frac{r^2}{\mu_0} \vb{E} \times \vb{B} \cdot \uv{r} \right|_{r \to \infty} = r^2 \varepsilon_0 c |\vb{E}|^2_{r \to \infty} \\
	&= \frac{c}{16\pi^2 \varepsilon_0} \sum_{n=1}^{\infty} \frac{1}{(n!)^2} \left( \left| \left( \uv{r}^{\otimes (n-1)} \cdot \frac{\partial^{n+1} \bm{\mathcal{P}}^{(n)}}{c^{n+1} \partial t^{n+1}} \right) \times \uv{r} \right|^2 + \left| \left( \uv{r}^{\otimes (n-1)} \cdot \frac{\partial^{n+1} \bm{\mathcal{M}}^{(n)}}{c^{n+2} \partial t^{n+1}} \right) \times \uv{r} \right|^2 \right) + \text{ct}, \\
	P_{\text{rad}} &= \frac{c}{4\pi \varepsilon_0} \sum_{n=1}^{\infty} \frac{2^n (n+1)}{n (2n+1)!} \left( \left\| \frac{\partial^{n+1} \bm{\mathcal{P}}^{(n)}}{c^{n+1} \partial t^{n+1}} \right\|^2 + \left\| \frac{\partial^{n+1} \bm{\mathcal{M}}^{(n)}}{c^{n+2} \partial t^{n+1}} \right\|^2 \right).
\end{equation*}
\normalsize
...
\small
\begin{equation*}
	&\frac{\d  \vb{L}_{\text{rad}}}{\d t \, \d \Omega} = \varepsilon_0\left. r^3 \left( (\vb{E} \cdot \uv{r})(\vb{E} \times \uv{r}) + c^2 (\vb{B} \cdot \uv{r})(\vb{B} \times \uv{r}) \right) \right|_{r \to \infty} \\
	&= \frac{1}{16\pi^2 \varepsilon_0} \sum_{n=1}^{\infty} \frac{n+1}{(n!)^2} \left[ \uv{r} \times \left( \uv{r}^{\otimes (n-1)} \cdot \frac{\partial^{n+1} \bm{\mathcal{P}}^{(n)}}{c^{n+1} \partial t^{n+1}} \right) \left( \uv{r}^{\otimes n} \cdot \frac{\partial^n \bm{\mathcal{P}}^{(n)}}{c^n \partial t^n} \right) + \uv{r} \times \left( \uv{r}^{\otimes (n-1)} \cdot \frac{\partial^{n+1} \bm{\mathcal{M}}^{(n)}}{c^{n+2} \partial t^{n+1}} \right) \left( \uv{r}^{\otimes n} \cdot \frac{\partial^n \bm{\mathcal{M}}^{(n)}}{c^{n+1} \partial t^n} \right) \right] +\text{ct}, \\
	&\frac{\d  \vb{L}_{\text{rad}}}{\d t} = \frac{1}{4\pi \varepsilon_0} \sum_{n=1}^{\infty} \frac{2^n (n+1)}{(2n+1)!} \left( \frac{\partial^{n+1} \bm{\mathcal{P}}^{(n)}}{c^{n+1} \partial t^{n+1}} \crossdot \frac{\partial^n \bm{\mathcal{P}}^{(n)}}{c^n \partial t^n} + \frac{\partial^{n+1} \bm{\mathcal{M}}^{(n)}}{c^{n+2} \partial t^{n+1}} \crossdot \frac{\partial^n \bm{\mathcal{M}}^{(n)}}{c^{n+1} \partial t^n} \right).
\end{equation*}
\normalsize

其中，来源于不同阶多极矩耦合的交叉项（ct,cross-terms）关于立体角积分后得零，\(\|\cdot\|^2\) 表示对张量的每一个分量取模方相加，\(\crossdot\) 表示对其中一个分量叉乘并对剩下的分量缩并，计算中用到关系式：
\begin{equation*}
	\int \uv{r}_{i_1} ... \uv{r}_{i_{2n}} \d \Omega = \frac{4\pi}{(2n+1)!!} \delta_{(i_1 i_2} \dots \delta_{i_{2n-1} i_{2n})}.
\end{equation*}

\subsubsection{三阶多极矩的推导细节}
在对赫兹矢量的展开过程中不难发现，当电磁多极矩精确到 \(\int (r')^2 \vb{J} \, \d \vb{r}'\) 项时，原先的电偶极矩就应该加上修正项：
\begin{equation*}
	-\frac{\partial}{c^2 \partial t} \cdot \frac{1}{10} \int \left( (\vb{r}' \cdot \vb{J}) \vb{r}' - 2 (r')^2 \vb{J} \right) \d \vb{r}' = -\frac{\partial \vb{T}}{c^2 \partial t},
\end{equation*}
其中：
\begin{equation*}
	\vb{T} = \frac{1}{10} \int \left( (\vb{r}' \cdot \vb{J}) \vb{r}' - 2 (r')^2 \vb{J} \right) \d \vb{r}'
\end{equation*}
称为环形电偶极矩（toroidal electric dipole）.

由于阶数较低，这一项可以直接由推迟势进行繁琐的泰勒展开得到，其准确性毋庸置疑.这里不妨采用赫兹矢量法，从原始多极矩出发，给出更为细致的推导，以令读者熟悉这一方法.

根据前面的讨论，未经任何规范变换的赫兹矢量可写成如下形式（精确到 \(\int (r')^2 \vb{J} \, \d \vb{r}'\) 项）：
\begin{equation*}
...
其中：
\begin{equation*}
	&P^{(1)} = \int \rho \vb{r}' \, \d \vb{r}', \quad P^{(2)} = \int \rho \vb{r}' \vb{r}' \, \d \vb{r}', \quad P^{(3)} = \int \rho \vb{r}' \vb{r}' \vb{r}' \, \d \vb{r}', \\
	&M^{(1)} = \frac{1}{2} \int \vb{r}' \times \vb{J} \, \d \vb{r}', \quad M^{(2)} = \frac{2}{3} \int \vb{r}' (\vb{r}' \times \vb{J}) \, \d \vb{r}'.
\end{equation*}

引入STF多极矩（\(\bm{\mathcal{P}}^{(1)}\) 暂缓引入）：
\begin{equation*}
	&\bm{\mathcal{P}}^{(2)} = \int \left( \vb{r}' \vb{r}' - \frac{1}{3} (r')^2 \vb{I} \right) \rho \, \d \vb{r}', \quad
	\bm{\mathcal{P}}^{(3)} = \int \left( \vb{r}' \vb{r}' \vb{r}' - \frac{1}{5} (r')^2 \delta_{(i_1 i_2} r'_{i_3)} \right) \rho \, \d \vb{r}', \\
	&\bm{\mathcal{M}}^{(1)} = \frac{1}{2} \int \vb{r}' \times \vb{J} \, \d \vb{r}', \quad     \bm{\mathcal{M}}^{(2)} = \frac{1}{3} \int \left( \vb{r}' (\vb{r}' \times \vb{J}) + (\vb{r}' \times \vb{J}) \vb{r}' \right) \d \vb{r}',
\end{equation*}
则：
\begin{equation*}
	\vb{\Pi}_e &= \frac{1}{4\pi} \left( \frac{P^{(1)}}{r} - \frac{1}{2} \nabla \cdot \left( \frac{\bm{\mathcal{P}}^{(2)}}{r} \right) + \frac{1}{6} \nabla \nabla : \left( \frac{\bm{\mathcal{P}}^{(3)}}{r} \right) \right) \\
	&\quad + \frac{1}{4\pi} \left( -\frac{1}{6} \nabla \left( \frac{\int (r')^2 \rho \, \d \vb{r}'}{r} \right) + \frac{1}{10} \nabla \left( \nabla \cdot \left( \frac{\int (r')^2 \vb{r}' \rho \, \d \vb{r}'}{r} \right) \right) - \frac{1}{30} \nabla \times \left( \nabla \times \left( \frac{\int (r')^2 \vb{r}' \rho \, \d \vb{r}'}{r} \right) \right) \right), \\
	\vb{\Pi}_m &= \frac{1}{4\pi} \left( \frac{\bm{\mathcal{M}}^{(1)}}{r} - \frac{1}{2} \nabla \cdot \left( \frac{\bm{\mathcal{M}}^{(2)}}{r} \right) \right) \\
	&\quad + \frac{1}{4\pi} \left( \frac{1}{30} \nabla \times \frac{\partial}{\partial t} \left( \frac{\int (r')^2 \vb{r}' \rho \, \d \vb{r}'}{r} \right) + \nabla \times \frac{\vb{T}}{r} \right).
\end{equation*}

进行规范变换 \(\vb{\Pi}_e \to \vb{\Pi}_e + \nabla \times \vb{G} - \nabla g_e\)，\(\vb{\Pi}_m \to \vb{\Pi}_m - \partial \vb{G}/\partial t- \nabla g_m\)，引入规范函数 \(g_m = 0\)，
\begin{equation*}
	g_e &= \frac{1}{4\pi} \left( \frac{1}{10} \nabla \cdot \left( \frac{\int (r')^2 \vb{r}' \rho \, \d \vb{r}'}{r} \right) - \frac{1}{6} \frac{\int (r')^2 \rho \, \d \vb{r}'}{r} + \nabla \cdot \int^t \frac{\vb{T}}{r} \d t \right), \\
	\vb{G} &= \frac{1}{4\pi} \left( \frac{1}{30} \nabla \times \left( \frac{\int (r')^2 \vb{r}' \rho \, \d \vb{r}'}{r} \right) + \nabla \times \int^t \frac{\vb{T}}{r} \d t \right),
\end{equation*}
其中易见 \(\left( \Delta - \partial^2/c^2\partial t^2\right) g_e = 0\).得：
\begin{equation*}
	\vb{\Pi}_e&\stackrel{\text{GT}}{=} \frac{1}{4\pi} \left( \frac{\bm{\mathcal{P}}^{(1)}}{r} - \frac{1}{2} \nabla \cdot \left( \frac{\bm{\mathcal{P}}^{(2)}}{r} \right) + \frac{1}{6} \nabla \nabla : \left( \frac{\bm{\mathcal{P}}^{(3)}}{r} \right) \right), \\
	\vb{\Pi}_m &\stackrel{\text{GT}}{=} \frac{1}{4\pi} \left( \frac{\bm{\mathcal{M}}^{(1)}}{r} - \frac{1}{2} \nabla \cdot \left( \frac{\bm{\mathcal{M}}^{(2)}}{r} \right) \right),
\end{equation*}
式中
\begin{equation*}
	\bm{\mathcal{P}}^{(1)} = P^{(1)} - \frac{1}{c^2} \frac{\partial \vb{T}}{\partial t},
\end{equation*}
正是之前求得的结果.
...
\begin{equation*}
	\vb{E} &= \frac{1}{\varepsilon_0} \nabla (\nabla \cdot \vb{\Pi}_e) - \mu_0 \left( \frac{\partial^2 \vb{\Pi}_e}{\partial t^2} + \nabla \times \frac{\partial \vb{\Pi}_m}{\partial t} \right) \\
	&= \frac{1}{4\pi \varepsilon_0} \left[ \frac{1}{r} \left( \left( \frac{\partial^2 \bm{\mathcal{P}}^{(1)}}{c^2 \partial t^2} \times \uv{r} \right) \times \uv{r} \right) + \frac{1}{r^3} \left( 1 + \frac{r}{c} \frac{\partial}{\partial t} \right) \left( 3 \uv{r} (\uv{r} \cdot \bm{\mathcal{P}}^{(1)}) - \bm{\mathcal{P}}^{(1)} \right) \right] \\
	&\quad + \frac{1}{8\pi \varepsilon_0} \Bigg[ \frac{1}{r} \left( \left( \frac{\partial^3 \bm{\mathcal{P}}^{(2)}}{\partial t^3} \cdot \uv{r} \right) \times \uv{r} \right) \times \uv{r}+ \frac{3}{r^2} \left( 2 \uv{r} \left( \uv{r} \uv{r} : \frac{\partial^2 \bm{\mathcal{P}}^{(2)}}{\partial t^2} \right) - \uv{r} \cdot \frac{\partial^2 \bm{\mathcal{P}}^{(2)}}{\partial t^2} \right) \\&\qquad+ \frac{3}{r^4} \left( 1 + \frac{r}{c} \frac{\partial}{\partial t} \right) \left( 5 \uv{r} \left( \uv{r} \uv{r} : \bm{\mathcal{P}}^{(2)} \right) - 2 \uv{r} \cdot \bm{\mathcal{P}}^{(2)} \right) \Bigg] \\
	&\quad + \frac{1}{24\pi \varepsilon_0} \Bigg[ \frac{1}{r} \frac{\partial^4}{c^4 \partial t^4} \left( \left( \uv{r} \uv{r} : \bm{\mathcal{P}}^{(3)} \right) \times \uv{r} \right) \times \uv{r} + \frac{2}{r^2} \frac{\partial^3}{c^2 \partial t^3} \left( 5 \uv{r} \left( \uv{r} \uv{r} \uv{r} \dotdotdot \bm{\mathcal{P}}^{(3)} \right) - 3 \uv{r} \uv{r} : \bm{\mathcal{P}}^{(3)} \right)  \\
		&\qquad+\frac{3}{r^3} \frac{\partial^2}{c^2 \partial t^2} \left( 15 \uv{r} \left( \uv{r} \uv{r} \uv{r}\dotdotdot \bm{\mathcal{P}}^{(3)} \right) - 7 \uv{r} \uv{r} : \bm{\mathcal{P}}^{(3)} \right) + \frac{15}{r^5} \left( 1 + \frac{r}{c} \frac{\partial}{\partial t} \right) \left( 7 \uv{r} \left( \uv{r} \uv{r} \uv{r} \dotdotdot \bm{\mathcal{P}}^{(3)} \right) - 3 \uv{r} \uv{r} : \bm{\mathcal{P}}^{(3)} \right) \Bigg] \\
	&\quad - \frac{1}{4\pi \varepsilon_0 c r^2} \left( 1 + \frac{r}{c} \frac{\partial}{\partial t} \right) \left( \frac{\partial \bm{\mathcal{M}}^{(1)}}{c \partial t} \times \uv{r} \right) - \frac{1}{8\pi \varepsilon_0 c} \left[ \frac{1}{r} \frac{\partial^3 \bm{\mathcal{M}}^{(2)}}{c^3 \partial t^3} \cdot \uv{r} + \frac{3}{r^3} \left( 1 + \frac{r}{c} \frac{\partial}{\partial t} \right) \frac{\partial \bm{\mathcal{M}}^{(2)}}{c \partial t} \cdot \uv{r} \right] \times \uv{r}
\end{equation*}
\begin{equation*}
	\vb{B} &= \mu_0 \left( \nabla \times \frac{\partial \vb{\Pi}_e}{\partial t} + \nabla \times (\nabla \times \vb{\Pi}_m) \right) \\
	&= \frac{\mu_0 c}{4\pi r^2} \left( 1 + \frac{r}{c} \frac{\partial}{\partial t} \right) \left( \frac{\partial \bm{\mathcal{P}}^{(1)}}{c \partial t} \times \uv{r} \right) + \frac{\mu_0 c}{8\pi} \left[ \frac{1}{r} \left( \left( \frac{\partial^3 \bm{\mathcal{P}}^{(2)}}{c^3 \partial t^3} \cdot \uv{r} \right) \times \uv{r} \right) + \frac{3}{r^3} \left( 1 + \frac{r}{c} \frac{\partial}{\partial t} \right) \left( \frac{\partial \bm{\mathcal{P}}^{(2)}}{c \partial t} \cdot \uv{r} \times \uv{r} \right) \right] \\
	&\quad+\dfrac{\mu_0 c}{24\pi} \bigg[
		...
		\bigg]
	\\
	&\quad + \frac{\mu_0}{4\pi} \left[ \frac{1}{r} \left( \left( \frac{\partial^2 \bm{\mathcal{M}}^{(1)}}{c^2 \partial t^2} \times \uv{r} \right) \times \uv{r} \right) + \frac{1}{r^3} \left( 1 + \frac{r}{c} \frac{\partial}{\partial t} \right) \left( 3 \uv{r} (\uv{r} \cdot \bm{\mathcal{M}}^{(1)}) - \bm{\mathcal{M}}^{(1)} \right) \right] \\
	&\quad + \frac{\mu_0}{8\pi} \Bigg[ \frac{1}{r} \left( \left( \frac{\partial^3 \bm{\mathcal{M}}^{(2)}}{\partial t^3} \cdot \uv{r} \right) \times \uv{r} \right) \times \uv{r} + \frac{3}{r^2} \left( 2 \uv{r} \left( \uv{r} \uv{r} : \frac{\partial^2 \bm{\mathcal{M}}^{(2)}}{\partial t^2} \right) - \uv{r} \cdot \frac{\partial^2 \bm{\mathcal{M}}^{(2)}}{\partial t^2} \right) + \\&\qquad\frac{3}{r^4} \left( 1 + \frac{r}{c} \frac{\partial}{\partial t} \right) \left( 5 \uv{r} \left( \uv{r} \uv{r} : \bm{\mathcal{M}}^{(2)} \right) - 2 \uv{r} \cdot \bm{\mathcal{M}}^{(2)} \right) \Bigg].\\
	P_{\text{rad}} &= \frac{c}{6\pi \varepsilon_0} \left( \left| \frac{\partial^2 \bm{\mathcal{P}}^{(1)}}{c^2 \partial t^2} \right|^2 + \left| \frac{\partial^2 \bm{\mathcal{M}}^{(1)}}{c^3 \partial t^2} \right|^2 \right) + \frac{c}{80\pi \varepsilon_0} \left( \left\| \frac{\partial^3 \bm{\mathcal{P}}^{(2)}}{c^3 \partial t^3} \right\|^2 + \left\| \frac{\partial^3 \bm{\mathcal{M}}^{(2)}}{c^4 \partial t^3} \right\|^2 \right) + \frac{c}{1890\pi \varepsilon_0} \left\| \frac{\partial^4 \bm{\mathcal{P}}^{(3)}}{c^4 \partial t^4} \right\|^2, \\
	\frac{\d  \vb{L}_{\text{rad}}}{\d t} &= \frac{1}{6\pi \varepsilon_0} \left[ \left( \frac{\partial \bm{\mathcal{P}}^{(1)}}{c \partial t} \times \frac{\partial^2 \bm{\mathcal{P}}^{(1)}}{c^3 \partial t^2} \right) + \left( \frac{\partial \bm{\mathcal{M}}^{(1)}}{c^2 \partial t} \times \frac{\partial^2 \bm{\mathcal{M}}^{(1)}}{c^4 \partial t^2} \right) \right] + \frac{1}{40\pi \varepsilon_0} \Bigg[ \left( \frac{\partial^2 \bm{\mathcal{P}}^{(2)}}{c^2 \partial t^2} \crossdot \frac{\partial^3 \bm{\mathcal{P}}^{(2)}}{c^3 \partial t^3} \right) \\\qquad\qquad&+ \left( \frac{\partial^2 \bm{\mathcal{M}}^{(2)}}{c^3 \partial t^2} \crossdot\frac{\partial^3 \bm{\mathcal{M}}^{(2)}}{c^4 \partial t^3} \right) \Bigg] + \frac{1}{630\pi \varepsilon_0} \left( \frac{\partial^3 \bm{\mathcal{P}}^{(3)}}{c^3 \partial t^3} \crossdot \frac{\partial^4 \bm{\mathcal{P}}^{(3)}}{c^4 \partial t^4} \right).
\end{equation*}
...
\begin{equation*}
	&\bm{\mathcal{P}}^{(1)} = - \frac{\partial\vb{T}}{c^2 \partial t},\quad \bm{\mathcal{P}}^{(2)}=\bm{\mathcal{P}}^{(3)}=0,\quad \bm{\mathcal{M}}^{(1)}=\bm{\mathcal{M}}^{(2)}=0.\\
...
\begin{notes}
	...
	\begin{equation*}
		&\bm{\mathcal{P}}^{(1)} = \bm{\mathcal{P}}^{(2)} = \bm{\mathcal{P}}^{(3)} = \bm{\mathcal{P}}^{(4)} = 0, \quad \bm{\mathcal{M}}^{(1)} = \frac{1}{c^2}\frac{\partial^2 \vb{T}_m}{\partial t^2}, \quad \bm{\mathcal{M}}^{(2)} = \bm{\mathcal{M}}^{(3)} = 0,\\
