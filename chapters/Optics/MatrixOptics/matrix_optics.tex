...
表示，则上式等价为
\begin{align*}
	 & z_{02}=\dfrac{f'\,\bigl(q_{01}^2 - z_{01}(f - z_{01})\bigr)}
	{q_{01}^2+(f - z_{01})^2},\quad q_{02}=\dfrac{q_{01}\,f\,f'}{q_{01}^2+(f - z_{01})^2}, \\[4pt]
	 & (z_{02}-f'-h')(z_{01}-f-h)=f\,f',
\end{align*}

可见，入射与出射光束中心位置满足牛顿成像定律.这是高斯光束经透镜组成像的又一特点.
