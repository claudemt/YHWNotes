...
\subsection{复合系统不变量、主面、节点与焦点}

\subsubsection{一般复合矩阵}
...
\subsection{Gaussian beam 的 \(q\) 参数与 ABCD 变换}

\subsubsection{从傍轴波动方程到复参数}
...
\subsubsection{几何光线与 Gaussian beam 的联系}
...
\subsection{完整光具组实例：两透镜四焦面 relay}
