...
\begin{equation*}
	...
	\frac{E}{NJ} &= -\frac{\sqrt{e^{-4\gamma} + \sinh^2\tilde{h}}\,\cosh\tilde{h} + \sinh^2\tilde{h} - e^{-4\gamma}}{\sqrt{e^{-4\gamma} + \sinh^2\tilde{h}} \left( \cosh\tilde{h} + \sqrt{e^{-4\gamma} + \sinh^2\tilde{h}} \right)}
\end{equation*}
